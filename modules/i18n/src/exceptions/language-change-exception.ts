 ...
 */
export class LanguageChangeException extends IdentityAppsModuleException {
    ...
    constructor(language: string, stack?: any) {
        super(`Failed to change the language to ${ language }`, stack, I18nModuleConstants.MODULE_NAME);
    }
}
