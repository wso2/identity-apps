    ...
    edit: {
        sections: {
            ...
            sharedAccess: {
                ...
                sharedRoles: "Assigned Roles",
                sharingSettings: "Role assignment settings for",
                individualRoleSharingLabel: "Individually Assigned Roles",
                individualRoleSharingHint: "These roles are assigned only to the selected organization. " +
                    "You can individually add or remove roles from organizations in this mode.",
                commonRoleSharingLabel: "Commonly Assigned Roles",
                commonRoleSharingHint: "This set of roles will be assigned to all existing and future organizations that " +
                ...
                allRolesSharingMessage: "All roles of the application will be assigned to the organization.",
                allRolesAndOrgsSharingMessage: "All roles of the application will be assigned to all the organizations.",
                allRolesAndOrgsNotSharingMessage: "No roles will be assigned to any organization.",
                allApplicationRolesSharingMessage: "All roles of the application will be assigned.",
                doNotShareRolesWithAllOrgs: "Do not assign roles to all organizations.",
                manageRoleSharing: "Manage role assignment",
                shareApplicationWithFutureChildOrgs: "Share application and roles with future child organizations",
                viewRoleSharing: "View assigned roles",
                ...
                orgNotSelectedForRoleSharing: "To assign roles, please select the organization from the left panel.",
                rolesSharedPartially: "Roles are selectively assigned to this organization.",
                shareRoleSubsetWithSelectedOrgs: "Assign a subset of roles to selected organizations",
                shareRoleSubsetWithAllOrgs: "Assign only a subset of roles to all organizations",
                ...
                doNotShareRoles: "Do Not Assign Roles",
                tabName: "Shared Access",
                selectAnOrganizationToViewRoles: "Select an organization to view the assigned roles.",
