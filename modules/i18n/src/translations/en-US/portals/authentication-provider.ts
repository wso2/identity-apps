...
export const authenticationProvider: AuthenticationProviderNS = {
           ...
           confirmations: {
               ...
               enableMultipleDeviceProgressiveEnrollment: {
                   ...
                   content:
                       "When enabled, users can register additional push devices before completing " +
                       "authentication. An attacker with the user's primary credentials could enroll their " +
                       "own device during sign-in and use it for future authentication. Enable this option " +
                       "only if your use case requires it.",
                   header: "Are you sure?",
           ...
           forms: {
               ...
               authenticatorSettings: {
                   ...
                   emailOTP: {
                       ...
                       resendBlockDuration: {
                           hint:
                               "The duration for which OTP resend is blocked after " +
                       ...
                       useAlphanumericChars: {
                           hint:
                               "Please check this checkbox to enable alphanumeric " +
                   ...
                   fido2: {
                       ...
                       trustedOrigins: {
                           hint:
                               "Origins from which FIDO-based authentication requests are initiated and need to be trusted by the server.",
                   ...
                   microsoft: {
                       ...
                       tenant: {
                           guide:
                               "Leave <1>common</1> as-is to let users from any Microsoft organization sign in. " +
                           ...
                           hint:
                               "Keep <1>common</1> to allow sign-in from any Microsoft organization, or enter your " +
                               "Directory (tenant) ID or domain (e.g. <3>contoso.onmicrosoft.com</3>) to restrict " +
                               "sign-in to a single organization.",
                           info:
                               'If your Microsoft app registration uses "Accounts in this organizational directory ' +
                           ...
                           validations: {
                               invalid:
                                   "Enter a valid Directory (tenant) ID (GUID), a domain such as " +
                                   'contoso.onmicrosoft.com, or one of "common", "organizations", or "consumers".',
                               required:
                                   'Directory (tenant) ID is required. Use "common" to allow any ' +
                   ...
                   smsOTP: {
                       ...
                       resendBlockDuration: {
                           hint:
                               "The time duration to block OTP resend requests after reaching the max allowed resend attempts",
                   ...
                   push: {
                       ...
                       enableNumberChallenge: {
                           hint:
                               "When enabled, users must confirm the number displayed in the application on their push authentication device to complete the sign in.",
                       ...
                       enableProgressiveEnrollment: {
                           ...
                           validations: {
                               required: "Enabling push notification device progressive enrollment is required."
                           }
                       },
                       enableDeviceRegistrationNotification: {
                           hint:
                               "When enabled, users will be notified when a new device is registered " +
                       ...
                       enableMultipleDeviceEnrollment: {
                           ...
                           validations: {
                               required: "Enabling multiple device enrollment is required."
                           }
                       },
                       maximumDeviceLimit: {
                           hint: "The maximum device limit for users when multiple device enrollment is enabled.",
                           label: "Maximum number of push devices",
                       ...
                       enableMultipleDeviceProgressiveEnrollment: {
                           hint:
                               "When enabled, users may progressively enroll additional devices for push authentication " +
                               "when multiple device enrollment is enabled.",
                           label: "Allow progressive enrollment for multiple devices",
                           securityWarning:
                               "Progressive enrollment for multiple devices is enabled. Users can register " +
                               "additional push devices before completing authentication, and an attacker with the user's " +
                               "primary credentials could enroll their own device during sign-in and use it for future " +
                               "authentication.",
                           validations: {
                               required: "Enabling progressive enrollment for multiple devices is required."
                           }
                       },
               ...
               certificateSection: {
                   ...
                   samlMetadataUrl: {
                       hint:
                           "The SAML metadata URL must point to a valid XML metadata document that contains " +
               ...
               jitProvisioning: {
                   ...
                   attributeSyncMethod: {
                       hint:
                           "Select the method used for syncing attributes between a JIT-provisioned " +
                       ...
                       options: {
                           overrideAll: {
                               label: "Override all",
                               description:
                                   "All attributes of the local user account will be overridden by " +
                                   "the attributes received from the external identity provider."
                           },
                           none: {
                               label: "None",
                               description:
                                   "None of the attributes received from the identity provider will " +
                                   "be synced with the local user account."
                           },
                           preserveLocal: {
                               label: "Preserve local",
                               description:
                                   "Only the attributes received from the identity provider will be " +
                   ...
                   associateLocalUser: {
                       hint:
                           "When enabled, users log in with this identity provider are linked to existing local users. If no linking rules are set, the email address is used by default.",
                   ...
                   skipJITForNoRuleMatch: {
                       hint:
                           "When enabled, if no local account is found using the attribute matching rules, " +
                       ...
                       infoMessage:
                           "If a matching local account is not found, a new account will be created by default. " +
                   ...
                   idpGroupSyncMethod: {
                       ...
                       hint:
                           "When enabled, existing roles will be replaced with new external IDP group roles during each login.",
                       label: "IDP group role synchronization method"
                   },
                   homeRealmIdentifier: {
                       hint:
                           "Specify an identifier for this connection. Applications can pass this value " +
               ...
               outboundProvisioningGroups: {
                   ...
                   hint:
                       "Select groups to automatically provision users when they are added, and deprovision them when they are removed.",
                   label: "Group",
               ...
               uriAttributeSettings: {
                   group: {
                       ...
                       mappedRolesAbsentMessage:
                           "With your current configuration, <1>Group Attribute</1> " +
                           "is not configured. " +
                           "You can select an attribute from the dropdown.",
                       mappedRolesPresentMessage:
                           "Please note that <1>{{ mappedRolesClaim }}</1> " +
           ...
           notifications: {
               ...
               addIDP: {
                   ...
                   microsoftTenantError: {
                       description:
                           "The connection was created, but applying the tenant-specific " +
               ...
               getLocalClaims: {
                   ...
                   genericError: {
                       description:
                           "An error occurred while retrieving local claims for account lookup attribute mappings.",
                       message: "Failed to retrieve local claims"
                   }
               },
               changeCertType: {
                   ...
                   pem: {
                       description: "Please note that the JWKS endpoint will be overridden " + "by the certificates.",
                       message: "Warning!"
                   }
               },
               deleteCertificate: {
           ...
           templates: {
               ...
               enterprise: {
                   ...
                   wizard: {
                       certificates: {
                           ...
                           jwksUrl: {
                               hint:
                                   "{{productName}} will use this URL to obtain keys to verify the" +
                           ...
                           pem: {
                               ...
                               hint:
                                   "{{productName}} will use this certificate to verify the signed" +
                           ...
                           samlMetadataUri: {
                               hint:
                                   "{{productName}} will use this URI to obtain the certificate to" +
               ...
               hypr: {
                   wizardHelp: {
                       apiToken: {
                           description:
                               "Provide the <1>API Token</1> obtained from " +
                               "HYPR. This will be used to access HYPR's APIs.",
                           heading: "API Token"
                       },
                       appId: {
                           description:
                               "Provide the <1>Application ID</1> of the " +
                       ...
                       preRequisites: {
                           heading: "Prerequisite",
                           rpDescription:
                               "Before you begin, create a relying party application " +
               ...
               iproov: {
                   wizardHelp: {
                       apiKey: {
                           description:
                               "Provide the <1>API Key</1> of the application " +
                               "registered in the iProov control center.",
                           heading: "API Key"
                       },
                       apiSecret: {
                           description:
                               "Provide the <1>API Secret</1> of the application " +
                               "registered in the iProov control center.",
                           heading: "API Secret"
                       },
                       baseUrl: {
                       ...
                       oauthPassword: {
                           description:
                               "Provide the <1>OAuth Password</1> of the application " +
                               "registered in the iProov control center.",
                           heading: "OAUTH Password"
                       },
                       oauthUsername: {
                           description:
                               "Provide the <1>OAuth Username</1> of " +
               ...
               digitalWallet: {
                   ...
                   wizardHelp: {
                       ...
                       presentationDefinition: {
                           ...
                           hint:
                               "Select a presentation definition that specifies the credentials and claims " +
                       ...
                       message: {
                           ...
                           paragraph2:
                               "The selected presentation definition determines which credentials and claims " +
