...
export const ai: aiNS = {
    aiLoginFlow: {
        ...
        screens: {
            loading: {
                facts:{
                    0: "Asgardeo features a visual editor that simplifies authentication flow configuration by "+
                    " allowing intuitive placement of authenticators and conditional elements, enhancing design " +
                    "efficiency.",
