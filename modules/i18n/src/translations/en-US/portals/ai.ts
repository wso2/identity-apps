...
export const ai: aiNS = {
    aiFlow: {
        disclaimer: "Flow AI can make errors. Verify the generated flow for accuracy and avoid entering sensitive personal data.",
        notifications: {
            generateError: {
                description: "An error occurred while generating the flow. Please try again.",
                message: "An error occurred"
            },
            generateInputError: {
                description: "The input provided for the flow generation is invalid. Please try again.",
                message: "Invalid input provided"
            },
            generateLimitError: {
                description: "You have exceeded the limit for flow generation. " +
                    "Please try again in a few moments.",
                message: "Limit exceeded"
            },
            generateResultError: {
                description: "An error occurred while retrieving the results of the flow generation. " +
                    "Please try again.",
                message: "An error occurred"
            },
            generateResultFailed: {
                description: "The generated flow was invalid. Please try again with a different prompt.",
                message: "Invalid flow generated"
            },
            generateStatusError: {
                description: "An error occurred while retrieving the status of the flow generation. " +
                    "Please try again.",
                message: "An error occurred"
            },
            generateSuccess: {
                description: "The flow has been generated successfully.",
                message: "Flow generated successfully"
            },
            rateLimitError: {
                description: "You have exceeded the rate limit for flow generation. Please try again in a few moments.",
        ...
        states: {
            ...
            1: "Gathering essential data for your flow...",
            2: "Applying final touches...",
            3: "Flow generation complete!"
        },
