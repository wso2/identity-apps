...
export const ai: aiNS = {
    aiLoginFlow: {
        ...
        disclaimer: "Login Flow AI can make errors. Verify the information for accuracy. Do not include any personal data such as usernames, mobile numbers, or any other sensitive information.",
        notifications: {
            generateError: {
