                ...
                types: {
                    preIssueAccessToken: {
                        ...
                        description: {
                            ...
                            expanded: "This action is executed before issuing the access token to an application. Use this action to manage claims and scopes of the access token. Refer the documentation for the API definition to implement."
                        }
                    },
                    preUpdatePassword: {
