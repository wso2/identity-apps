...
export const userPortal: UserPortalNS = {
    ...
    placeholders: {
        ...
        sessionStorageDisabled: {
            subtitles: {
                0: "உங்கள் உலாவியின் அமைப்புகள் தரவைச் சேமிக்க அனுமதிக்காது என்று தெரிகிறது.",
                1: "இந்த செயலி சரியாக செயல்பட உங்கள் உலாவியில் தரவை சேமிக்கும் பயன்பாட்டை இயக்கவும்."
            },
            title: "தரவை சேமிக்க உங்கள் உலாவி அனுமதிக்காது"
        }
    },
    sections: {
        accountRecovery: {
