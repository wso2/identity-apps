    ...
    components: {
        ...
        profile: {
            ...
            messages: {
                ...
                mobileConfirmation: {
                    content: {
                        addMobileNumber: "மொபைல் எண் புதுப்பிப்பை உறுதிப்படுத்த இங்கே கிளிக் செய்க.",
                        updateMobileNumber: "மொபைல் எண் புதுப்பிப்பை உறுதிப்படுத்த இங்கே கிளிக் செய்க. நிலுவையில் உள்ள " +
                            "மொபைல் எண்ணை வெற்றிகரமாக சரிபார்க்கும் வரை, முன்பு சரிபார்க்கப்பட்ட மொபைல் எண் " +
                            "{{mobileNumber}} பயன்படுத்தப்படும்.",
                    },
                    header: "உறுதிப்படுத்தல் நிலுவையில் உள்ளது!",
