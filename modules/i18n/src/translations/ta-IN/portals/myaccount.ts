        ...
        mfa: {
            authenticatorApp: {
                ...
                configuredDescription: "இரண்டு காரணி அங்கீகாரத்திற்காக உங்கள் உள்ளமைக்கப்பட்ட " +
                    "அங்கீகார பயன்பாட்டிலிருந்து TOTP குறியீடுகளைப் பயன்படுத்தலாம். பயன்பாட்டிற்கான " +
                    "அணுகல் உங்களுக்கு இல்லையென்றால், இங்கிருந்து நீக்கலாம் அல்லது புதிய ஒன்றை அமைக்கலாம்.",
                heading: "அங்கீகார பயன்பாடு",
                hint: "QR குறியீட்டினை காண்பி",
                deleteHint: "உங்கள் TOTP அங்கீகாரத்தை நீக்கவும்",
                modals: {
                    ...
                    delete : {
                        heading: "உறுதிப்படுத்தல்",
                        message: "இந்த செயல் கட்டமைக்கப்பட்ட TOTP அங்கீகாரத்தை அகற்றும். " +
                        ...
                        email: {
                            ...
                            validations: {
                                ...
                                invalidFormat: "மின்னஞ்சல் முகவரி சரியான வடிவத்தில் இல்லை. நீங்கள் எண்ணெழுத்து எழுத்துக்கள், " +
                                    "யூனிகோட் எழுத்துக்கள், அடிக்கோடிட்டு (_), கோடுகள் (-), காலங்கள் (.) " +
                                    "மற்றும் ஒரு அடையாளம் (@) ஆகியவற்றைப் பயன்படுத்தலாம்."
                            }
                        }
                    }
                },
