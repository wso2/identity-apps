                        ...
                        sections: {
                                ...
                                fields: {
                                    bindingType: {
                                        ...
                                        description: "{{productName} ට <1>ප්‍රවේශවීමේ ටෝකනය</1> බැඳ තැබිය හැකි අතර " +
                                            "පිවිසුම් සැසියට <3>ටෝකනය නැවුම්</3> කළ හැකිය. මෙම සැකසුම මඟින් ටෝකනය පිවිසුම් සැසියට " +
                            ...
                            idToken: {
                                fields: {
                                    ...
                                    audience: {
                                        hint: "මෙම <1>හැඳුනුම් ටෝකනය</1> අදහස් කර ඇති ලබන්නා සඳහන් කරන්න. පෙරනිමියෙන්," +
                                    ...
                                    encryption: {
                                        hint: "ඔබගේ යෙදුමේ පොදු යතුර භාවිතයෙන් ටෝකනය නිකුත් කිරීමේදී <1>හැඳුනුම්පත් ටෝකන</1> "+
