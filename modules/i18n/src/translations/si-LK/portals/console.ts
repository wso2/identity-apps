    ...
    brandingCustomText: {
        ...
        form: {
            ...
            fields: {
                ...
                "privacy.policy": {
                    hint: "පිවිසුම් තිරවල පාදකයේ දිස්වන රහස්යතා ප්රතිපත්ති පා text ය.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "site.title": {
                    hint: "බ්රව්සර් ටැබ්, සෙවුම් යන්ත්ර, සමාජ කොටස් යනාදියෙහි දිස්විය හැකිය. {{productName}} පෙරනිමි භාවිතා කරයි."
                },
                "terms.of.service": {
                    hint: "පිවිසුම් තිරවල පාදකයේ දිස්වන සේවා පා text යේ නියමයන්.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "login.button": {
                ...
                "password.recovery.body": {
                    hint: "මුරපද ප්රතිසාධන පෙට්ටියේ ශරීර පෙළ.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "password.recovery.button": {
                    hint: "මුරපද ප්රතිසාධන පෙට්ටියේ ප්රධාන ක්රියාකාරී බොත්තමෙහි දිස්වන පෙළ.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "password.recovery.heading": {
                    hint: "මුරපද ප්රතිසාධන පෙට්ටියේ ශීර්ෂය.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "password.reset.button": {
                    hint: "මුරපද යළි පිහිටුවීමේ කොටුවේ ප්රධාන ක්රියාකාරී බොත්තමෙහි දිස්වන පෙළ.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                "password.reset.heading": {
                    hint: "මුරපද යළි පිහිටුවීමේ කොටුවෙහි ශීර්ෂය.සකසා නොමැති නම්, {{productName}} පෙරනිමි භාවිතා වේ."
                },
                    ...
                    advancedAttributeSettings: {
                        sections: {
                            linkedAccounts: {
                                ...
                                descriptionFederated: "ෆෙඩරේටඩ් සත්‍යාපනය අතරතුර සබැඳි දේශීය ගිණුමේ පරිශීලක ගුණාංග ලබා ගැනීමට සබල කරන්න.",
                                fields: {
                                    validateLocalAccount: {
                                        label: "දේශීය ගිණුම් ගුණාංගවලට ප්‍රමුඛත්වය දෙන්න",
                                        hint: "සම්බන්ධිත දේශීය ගිණුමක් තිබේ නම්, එහි ගුණාංග ආපසු ලබා දෙනු ලැබේ. එසේ නොමැතිනම්, " +
                                        "ෆෙඩරේටඩ් අනන්‍යතාවයේ ගුණාංග ආපසු ලබා දෙනු ලැබේ."
                                    },
                                    mandateLocalAccount: {
                                        label: "සම්බන්ධිත දේශීය ගිණුම අනිවාර්ය කරන්න",
                                        hint: "ෆෙඩරේටඩ් අනන්‍යතාවය සමඟ සම්බන්ධිත දේශීය ගිණුමක් නොමැති නම් ටෝකන් හුවමාරු ප්‍රදානයේදී සත්‍යාපනය අසාර්ථක වනු ඇත."
                                    }
                                }
                            },
                            role: {
                            ...
                            subject: {
                                fields: {
                                    alternateSubjectAttribute: {
                                        hint: "මෙම විකල්පය <1>පරිශීලක</1> වෙනුවට විෂය අනන්යතාවය ලෙස විකල්ප ලක්ෂණයක් භාවිතා කිරීමට ඉඩ සලසයි.",
                                        label: "විකල්ප විෂය හඳුනාගැනීමක් ලබා දෙන්න"
                                    },
                                    subjectAttribute: {
                ...
                forms:{
                    uriAttributeSettings: {
                        group: {
                            ...
                            mappedRolesAbsentMessage: "ඔබගේ වත්මන් වින්යාසය සමඟ, <1>කණ්ඩායම් ආරෝපණය</1> වින්යාස කර නොමැත. " +
                                "ඔබට පතන සිට ලක්ෂණයක් තෝරා ගත හැකිය.",
                            mappedRolesPresentMessage: "කරුණාකර එය සටහන් කරන්න <1>{{ mappedRolesClaim }}</1> " +
                                "<1>{{ rolesClaim }}</1> ලෙස සලකනු ලැබේ <1> කණ්ඩායම් ගුණාංගය</1> වත්මන් වින්යාසය සමඟ. " +
                                "ඔබට පතන සිට ලක්ෂණයක් තෝරා ගත හැකිය.",
                            messageOIDC: "OpenID සම්බන්ධක ගුණාංගය නම් කර ඇති බව කරුණාවෙන් සලකන්න <1>{{ attribute }}</1> පෙරනිමිය ලෙස සලකනු ලැබේ " +
                                "<1>කණ්ඩායම් ගුණාංගය</1> ඔබ අභිරුචි ආරෝපණ සිතියම්කරණයක් එකතු කර නොමැති බැවින්.",
                            messageSAML: "කරුණාකර එය සටහන් කරන්න <1>{{ attribute }}</1> උද්ධමනය පෙරනිමිය ලෙස සලකනු ලැබේ " +
                                "<1>කණ්ඩායම් ගුණාංගය</1> ඔබ අභිරුචි ආරෝපණ සිතියම්කරණයක් එකතු කර නොමැති බැවින්.",
                            placeHolder: "ගුණාංගය තෝරන්න",
                            roleMappingDisabledMessage: "<1> අභිරුචි ආරෝපණය සිතියම්ගත කිරීම </1> අක්රීය කර ඇත " +
                                "ඔබේ වින්යාසය.මෙය සමහර ප්රවාහවලට බලපායි " +
                                "අයදුම්පත. ප්රවේශමෙන් ඉදිරියට යන්න.",
                            validation: {
                ...
                templates: {
                    ...
                    trustedTokenIssuer: {
                        addWizard: {
                            ...
                            subtitle: "{{productName}} නිකුත් කළ ටෝකනයක් සඳහා සිය ටෝකනය හුවමාරු කර ගැනීම සඳහා විශ්වාසදායක ටෝකන් " +
                        ...
                        forms: {
                            ...
                            jwksUrl: {
                                ...
                                hint: "ඔබේ විශ්වාසවන්ත ටෝකන් නිකුත් කරන්නාගෙන් අත්සන් කළ ප්රතිචාර සත්යාපනය කිරීම සඳහා {{productName}} "
                            ...
                            pem: {
                                ...
                                hint: "{{productName}} විසින් ඔබගේ විශ්වාසදායක ටෝකන් නිකුත් කරන්නාගෙන් අත්සන් කළ ප්රතිචාර සත්යාපනය කිරීම " +
                ...
                forms: {
                    advancedConfigs: {
                        ...
                        implicitAssociation: {
                            ...
                            primaryAttribute: {
                                label: "මූලික සෙවීම් ගුණාංගය",
                                hint: "ගැළපෙන දේශීය පරිශීලක ගිණුමක් තිබේදැයි පරීක්ෂා කිරීමට භාවිත කරන" +
                                    " මූලික ගුණාංගය තෝරන්න"
                            },
                            secondaryAttribute: {
                                label: "ද්විතියික සෙවීම් ගුණාංගය",
                                hint: "ප්‍රාථමික උපලක්ෂණයෙන් අනන්‍ය පරිශීලකයෙකු හමු නොවන්නේ නම් ද්විතියික උපලක්ෂණ භාවිතා කරනු ඇත"
                            },
        ...
        features: {
            ...
            parentOrgInvitations: {
                addUserWizard: {
                    ...
                    groups: {
                        label: "කණ්ඩායම්",
                        placeholder: "කණ්ඩායම් තෝරන්න",
                        hint: "ආරාධනා කරනු ලබන පරිශීලකයා සඳහා කණ්ඩායම් පවරන්න.",
                        validations: {
                            required: "කණ්ඩායම් යනු අවශ්‍ය ක්ෂේත්‍රයකි."
                        }
                    },
            ...
            userstores: {
                ...
                placeholders: {
                    ...
                    emptyListReadOnly: {
                        subtitles: "දැනට පරිශීලක වෙළඳසැල් නොමැත.",
                        title: "පරිශීලක වෙළඳසැල් නොමැත"
                    },
                    emptySearch: {
                        action: "සෙවුම් විමසුම හිස් කරන්න",
