                            ...
                            subject: {
                                fields: {
                                    ...
                                    subjectType: {
                                        ...
                                        public: {
                                            label: "පොදු",
                                            hint: "මෙම විකල්පය විෂය ලෙස පොදු විෂය හඳුනාගැනීම භාවිතා කරනු ඇත."
                                        },
                                        pairwise: {
                                            label: "යුගල වශයෙන්",
                                            hint: "මෙම විකල්පය විෂය ලෙස යුගල වශයෙන් විෂය හඳුනාගැනීම භාවිතා කරනු ඇත."
                                        }
                                    },
                                    sectorIdentifierURI: {
                                        label: "විෂය හඳුනාගැනීමේ URI",
                        ...
                        sections: {
                            ...
                            clientAuthentication: {
                                fields: {
                                    ...
                                    subjectDN: {
                                        label: "TLS සේවාදායක සත්‍යාපන විෂය DN"
                                    }
                                },
                                ...
                                fields: {
                                    requirePushAuthorizationRequest: {
                                        hint: "තල්ලු කරන ලද අවසර ඉල්ලීම් ලෙස අවසර ඉල්ලීම් යැවීමට යෙදුමට අනිවාර්ය කිරීමට " +
                                            "තෝරන්න.",
                                        label: "තල්ලු කළ අවසර ඉල්ලීම් අවශ්‍යයි"
                                    }
                                },
