    ...
    develop: {
                ...
                edit: {
                    sections: {
                        ...
                        info: {
                            ...
                            oidcSubHeading: "OpenID Connect භාවිතයෙන් ඔබගේ යෙදුම සඳහා සත්‍යාපනය ක්‍රියාත්මක කිරීමට සහ " +
                                "වින්‍යාස කිරීමට පහත සේවාදායක අන්ත ලක්ෂ්‍ය ඔබට ප්‍රයෝජනවත් වනු ඇත.",
                            samlHeading: "අනන්‍යතා සැපයුම්කරුගේ විස්තර",
                            samlSubHeading: "SAML 2.0 භාවිතා කරමින් ඔබගේ යෙදුම සඳහා සත්‍යාපනය ක්‍රියාත්මක කිරීමට සහ වින්‍යාස " +
                                "කිරීමට පහත අනන්‍යතා සැපයුම්කරුගේ විස්තර ඔබට ප්‍රයෝජනවත් වනු ඇත.",
                            tabName: "තොරතුරු"
                        },
                        general: {
                            tabName: "ජනරාල්"
                                    ...
                                    sections: {
                                        scriptBased: {
                                            ...
                                            editor: {
                                                ...
                                                changeConfirmation: {
                                                    content: "තෝරාගත් අච්චුව සංස්කාරකයේ දැනට පවතින ස්ක්‍රිප්ට් මෙන්ම ඔබ වින්‍යාස " +
                                                        "කළ පිවිසුම් පියවර ද ප්‍රතිස්ථාපනය කරයි. ඉදිරියට යාමට " +
                                                        "<1>තහවුරු කරන්න</1> ක්ලික් කරන්න.",
                                                    heading: "ඔබට විශ්වාසද?",
                                                    message: "මෙම ක්‍රියාව ආපසු හැරවිය නොහැක."
                                                },
                                                goToApiDocumentation: "API ප්‍රලේඛනය වෙත යන්න",
                                                resetConfirmation: {
                                                    content: "මමෙම ක්‍රියාව මඟින් සංස්කාරකයේ දැනට පවතින ස්ක්‍රිප්ට් නැවත " +
                                                        "පෙරනිමිය වෙත ගෙන යනු ඇත. ඉදිරියට යාමට <1>තහවුරු කරන්න</1> " +
                                                        "ක්ලික් කරන්න.",
                                                    heading: "ඔබට විශ්වාසද?",
                                                    message: "මෙම ක්‍රියාව ආපසු හැරවිය නොහැක."
                                                },
                                        ...
                                        stepBased: {
                                            ...
                                            secondFactorDisabled: "දෙවන සාධක සත්‍යාපනය භාවිතා කළ හැක්කේ <1>පරිශීලක නාමය " +
                                                "සහ මුරපදය</1>, <3>සමාජ පිවිසුම</3> හෝ මෙම සාධක හැසිරවිය හැකි <5>" +
                                                "හැඳුනුම්පත පළමුව</5> වැනි වෙනත් ඕනෑම හසුරුවන්නන් නම් පමණි. පෙර පියවරක පවතී.",
                                            secondFactorDisabledInFirstStep: "පළමු පියවරේදී දෙවන සාධක සත්‍යාපක භාවිතා කළ " +
                                                "නොහැක."
                                        }
                                    }
                                },
        ...
        pages: {
            applicationTemplate: {
                ...
                subTitle: "පහත දක්වා ඇති එක් අච්චුවක් භාවිතා කර අයදුම්පතක් ලියාපදිංචි කරන්න. ඔබේ යෙදුම් වර්ගයට කිසිවක් ගැලපෙන්නේ " +
                    "නැත්නම්, සම්මත පදනම් කරගත් යෙදුම් අච්චුව සමඟ ආරම්භ කරන්න.",
    ...
    manage: {
        features: {
            ...
            user: {
                deleteJITUser: {
                    confirmationModal: {
                        content: "ඔබ මෙම පරිශීලකයා මකා දැමුවහොත්, ඊළඟ වතාවේ පරිශීලකයා සමාජ පිවිසුම් විකල්පයක් භාවිතා කරන විට පුරනය " +
                            "වන තුරු පරිශීලකයාට මගේ ගිණුමට හෝ පරිශීලකයා දායක වූ වෙනත් යෙදුමකට ප්‍රවේශ විය නොහැක."
                    }
                },
                deleteUser: {
                    confirmationModal: {
                ...
                editUser: {
                    dangerZoneGroup: {
                        deleteUserZone: {
                            ...
                            subheader: "මෙම ක්‍රියාව මඟින් පරිශීලකයා ආයතනයෙන් ස්ථිරවම මකනු ඇත. ඉදිරියට යාමට පෙර කරුණාකර " +
                                "සහතික වන්න."
                        },
                        disableUserZone: {
                        ...
                        inputs: {
                            ...
                            username: {
                                ...
                                validations: {
                                    ...
                                    regExViolation: "ඔබේ විද්‍යුත් තැපෑලේ අනුලකුණු 3 සිට 50 දක්වා අඩංගු විය යුතුය. ඔබට අක්ෂරාංක, " +
                                        "යුනිකෝඩ් අක්ෂර, ඉරි (-), යටි ඉරි (_), ධන ලකුණු (+), නැවතුම් ලකුණු (.), සහ at ලකුණක් " +
                                        "(@) භාවිතා කළ හැකිය."
                                }
                            }
                        },
                ...
                lockUser: {
                    confirmationModal: {
                        assertionHint: "කරුණාකර ඔබේ ක්‍රියාව තහවුරු කරන්න.",
                        content: "ඔබ මෙම ගිණුම අගුළු දැමුවහොත්, පරිශීලකයාට My Account වෙත හෝ කිසිදු ව්‍යාපාරික යෙදුමකට " +
                            "පිරීමට නොහැකි වේ. කරුණාකර ප්‍රවේශමෙන් ඉදිරියට යන්න.",
                        header: "ඔබට විශ්වාසද?",
                ...
                modals: {
                    ...
                    changePasswordModal: {
                        ...
                        message: "අනතුරු ඇඟවීම: මුරපදය වෙනස් කිරීමෙන් පසුව පරිශීලකයාට වත්මන් මුරපදය භාවිතා කර කිසිදු යෙදුමකට " +
                            "පිවිසිය නොහැකි බව කරුණාවෙන් සලකන්න.",
                        hint: {
                            forceReset: "අනතුරු ඇඟවීම: මුරපදය නැවත සැකසීමට පරිශීලකයාට ආරාධනා කිරීමෙන් පසු වත්මන් මුරපදය භාවිතා කර " +
                                "පරිශීලකයාට කිසිදු යෙදුමකට පිවිසිය නොහැකි බව කරුණාවෙන් සලකන්න. මුරපද යළි පිහිටුවීමේ සම්බන්ධකය විනාඩි " +
                                "{{codeValidityPeriod}} ක් සඳහා වලංගු වේ.",
                            setPassword: "අනතුරු ඇඟවීම: මුරපදය වෙනස් කිරීමෙන් පසුව පරිශීලකයාට වත්මන් මුරපදය භාවිතා කර කිසිදු යෙදුමකට " +
                                "පිවිසිය නොහැකි බව කරුණාවෙන් සලකන්න."
                        },
                        passwordOptions: {
                ...
                updateUser: {
                    ...
                    roles: {
                        ...
                        editRoles: {
                            confirmationModal: {
                                assertionHint: "කරුණාකර ඔබේ ක්‍රියාව තහවුරු කරන්න.",
                                content: "භූමිකාව වෙනස් කිරීමෙන් පරිශීලකයාට ප්‍රවේශය අහිමි වීම හෝ යම් විශේෂාංග වෙත ප්‍රවේශය " +
                                    "ලැබීම සිදු වේ. කරුණාකර ප්‍රවේශමෙන් ඉදිරියට යන්න.",
                                header: "ඔබට විශ්වාසද?",
                    ...
                    fields: {
                        username: {
                            ...
                            validations: {
                                ...
                                invalidCharacters: "පරිශීලක නාමය අවලංගු අක්ෂර අඩංගු බව පෙනේ.",
                                regExViolation: "ඔබේ විද්‍යුත් තැපෑලේ අනුලකුණු 3 සිට 50 දක්වා අඩංගු විය යුතුය. ඔබට අක්ෂරාංක, " +
                                    "යුනිකෝඩ් අක්ෂර, ඉරි (-), යටි ඉරි (_), නැවතුම් ලකුණු (.), සහ at ලකුණක් " +
                                    "(@) භාවිතා කළ හැකිය."
                            }
                        }
                    }
