    ...
    develop: {
        ...
        pages: {
            applicationTemplate: {
                ...
                subTitle: "පහත දක්වා ඇති එක් අච්චුවක් භාවිතා කර අයදුම්පතක් ලියාපදිංචි කරන්න. ඔබේ යෙදුම් වර්ගය සඳහා ගැළපෙන අච්චුවක් " +
                    "ඔබට සොයාගත නොහැකි නම්, සම්මත පදනම් කරගත් යෙදුම් අච්චුව සමඟ ආරම්භ කරන්න.",
