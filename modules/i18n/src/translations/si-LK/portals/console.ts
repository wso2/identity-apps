                ...
                forms: {
                    ...
                    advancedConfig: {
                        fields: {
                            ...
                            saas: {
                                hint: "පෙරනිමියෙන්, යෙදුම් භාවිතා කළ හැක්කේ යෙදුමේ tenantට අයත් පරිශීලකයින්ට පමණි. " +
                                    "මෙම යෙදුම SaaS- සක්‍රීය කර ඇත්නම්, මෙම යෙදුම tenant හරහා පරිශීලකයින්ට ප්‍රවේශ " +
                                    "වීමට විවෘත වේ.",
                                label: "SaaS යෙදුම",
                                validations: {
                                    empty: "මෙය අත්‍යවශ්‍ය ක්ෂේත්‍රයකි."
                    ...
                    inboundOIDC: {
                        ...
                        fields: {
                            ...
                            callBackUrls: {
                                hint: "පරිශීලකයා සත්‍යාපනය කළ පසු බලය පැවරීමේ කේතය යවන්නේ කොතැනටද, සහ පිටවීම අවසන් " +
                                    "වූ පසු පරිශීලකයා හරවා යැවිය යුත්තේ කොතැනටද යන්න යළි-යොමුවීමේ URL මගින් තීරණය වේ. " +
                                    "ග්‍රාහක යෙදුම විසින් යවන ලද යළි-යොමුවීම් URL සහ සත්‍යාපන ඉල්ලීම් සහ ඉවත් වීමේ ඉල්ලීම් " +
                                    "මෙහි දක්වා ඇති URL වලට එරෙහිව වලංගු වේ.",
