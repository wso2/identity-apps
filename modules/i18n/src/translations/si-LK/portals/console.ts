            ...
            authenticationProvider: {
                templates: {
                    apple: {
                        wizardHelp: {
                            clientId: {
                                description: "ඇපල්හි නිර්මාණය කරන ලද <1>සේවා හැඳුනුම්පත</1> ඉතා සරල ලෙස සපයන්න.",
                                heading: "සේවා හැඳුනුම්පත"
                            },
                            heading: "උදව්",
                            keyId: {
                                description: "උත්පාදනය කරන ලද පුද්ගලික යතුරේ <1>යතුරු හැඳුනුම්කාරකයේ යතුරු හැකියාව</1> සපයන්න.",
                                heading: "යතුරු හැඳුනුම්පත"
                            },
                            name: {
                                connectionDescription: "අදාලව සම්බන්ධතාවය සඳහා අංක වෙන්කරවීම සඳහා වැදගත් නමක් ලබා දෙන්න.",
                                idpDescription: "අදාලව සම්බන්ධතාවය සඳහා අංක වෙන්කරවීම සඳහා වැදගත් නමක් ලබා දෙන්න.",
                                heading: "නම"
                            },
                            preRequisites: {
                            ...
                            privateKey: {
                                description: "යෙදුම සඳහා ජනනය කරන ලද <1>පුද්ගලික යතුර</1> සපයන්නේ කුමන ලෙස නම්.",
                                heading: "පුද්ගලික යතුර"
                            },
                            subHeading: "පහත මාර්ගෝපදේශය භාවිතා කරන්න",
                            teamId: {
                                description: "ඇපල් සංවර්ධක <1>කණ්ඩායම් හැඳුනුම්පත</1> ඉතා සරල ලෙස සපයන්න.",
                        ...
                        wizardHelp: {
                            name: {
                                description: "එය පහසුවෙන් හඳුනාගත හැකි වන පරිදි ව්‍යවසාය සත්‍යාපන සැපයුම්කරු සඳහා අද්විතීය නමක්" +
                                    " ලබා දෙන්න.",
                                heading: "නම",
                                example: "උදා., MyOrgEnterpriseAuthProvider."
                            },
                            description: {
