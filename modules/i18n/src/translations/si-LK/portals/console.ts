                                ...
                                authenticationFlow: {
                                    ...
                                    sections: {
                                        ...
                                        stepBased: {
                                            ...
                                            secondFactorDisabledDueToProxyMode: "<0>TOTP</0> සහ <2>ඊමේල් OTP</2> වැනි" +
                                                " දෙවන-සාධක සත්‍යාපන යන්ත්‍ර වින්‍යාස කිරීමට, පරිශීලකයින්ට ප්‍රාදේශීය ගිණුමක් තිබිය" +
                                                " යුතුය. නමුත් පෙර සත්‍යාපන හසුරුව <4>ප්‍රොක්සි මාදිලිය</4> සක්‍රීය කර ඇත.",
                ...
                forms: {
                    ...
                    jitProvisioning: {
                        enableJITProvisioning: {
                            disabledMessageHeader: "ප්‍රොක්සි මාදිලියේ ගැටුම",
                            disabledMessageContent: {
                                1: "බහු යෙදුම් මෙම සම්බන්ධතාවය මත රඳා පවතින බැවින් ඔබට ප්‍රොක්සි මාදිලියේ සිටුවම් වෙනස් කළ " +
                                    "නොහැක. මෙම ගැටුම විසඳීමට, ඔබ ලැයිස්තුගත සම්පත් වලින් මෙම සම්බන්ධතාවය ඉවත් කළ යුතුය.",
                                2: "යෙදුමක් මෙම සම්බන්ධතාවය මත රඳා පවතින බැවින් ඔබට ප්‍රොක්සි මාදිලියේ සිටුවම් වෙනස්" +
                                    " කිරීමට අවසර නැත. මෙම ගැටුම විසඳීමට, ඔබ ලැයිස්තුගත සම්පතෙන් මෙම සම්බන්ධතාවය" +
                                    " ඉවත් කළ යුතුය."
                            },
        ...
        features: {
            ...
            user: {
                        ...
                        inputs: {
                            ...
                            username: {
                                ...
                                validations: {
                                    ...
                                    regExViolation: "ඔබේ විද්‍යුත් තැපෑලේ අනුලකුණු 3 සිට 50 දක්වා අඩංගු විය යුතුය. " +
                                        "ඔබට අක්ෂරාංක, යුනිකෝඩ් අක්ෂර, ඉරි (-), යටි ඉරි (_), ධන ලකුණු (+), " +
                                        "නැවතුම් ලකුණු (.), සහ at ලකුණක් (@) භාවිතා කළ හැකිය."
                                }
                            }
                        },
                        validations: {
                ...
                lockUser: {
                    confirmationModal: {
                        assertionHint: "කරුණාකර ඔබේ ක්‍රියාව තහවුරු කරන්න.",
                        content: "ඔබ මෙම ගිණුම අගුළු දැමුවහොත්, පරිශීලකයාට My Account වෙත හෝ කිසිදු " +
                            "ව්‍යාපාරික යෙදුමකට පිරීමට නොහැකි වේ. කරුණාකර ප්‍රවේශමෙන් ඉදිරියට යන්න.",
                        header: "ඔබට විශ්වාසද?",
                    ...
                    fields: {
                        username: {
                            ...
                            validations: {
                                ...
                                invalidCharacters: "පරිශීලක නාමය අවලංගු අක්ෂර අඩංගු බව පෙනේ.",
                                regExViolation: "ඔබේ විද්‍යුත් තැපෑලේ අනුලකුණු 3 සිට 50 දක්වා අඩංගු විය යුතුය. " +
                                    "ඔබට අක්ෂරාංක, යුනිකෝඩ් අක්ෂර, ඉරි (-), යටි ඉරි (_), ධන ලකුණු (+), නැවතුම් " +
                                    "ලකුණු (.), සහ at ලකුණක් (@) භාවිතා කළ හැකිය."
                            }
                        }
                    }
                },
                    ...
                    fields: {
                        username: {
                            ...
                            validations: {
                                ...
                                invalidCharacters: "පරිශීලක නාමය අවලංගු අක්ෂර අඩංගු බව පෙනේ.",
                                regExViolation: "ඔබේ විද්‍යුත් තැපෑලේ අනුලකුණු 3 සිට 50 දක්වා අඩංගු විය යුතුය. " +
                                    "ඔබට අක්ෂරාංක, යුනිකෝඩ් අක්ෂර, ඉරි (-), යටි ඉරි (_), නැවතුම් ලකුණු (.), සහ " +
                                    "at ලකුණක් (@) භාවිතා කළ හැකිය."
                            }
                        }
                    }
                },
