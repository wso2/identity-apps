                ...
                forms: {
                    ...
                    inboundOIDC: {
                        ...
                        fields: {
                            ...
                            callBackUrls: {
                                hint: "සත්‍යාපනයෙන් පසුව, අපි ඉහත යළි-යොමුවීම් URI වෙත පමණක් හරවා " +
                                    "යවන අතර ඔබට බහු URI නියම කළ හැකිය",
                                label: "URI යලි හරවන්න",
                                placeholder: "https://myapp.io/login",
                                validations: {
                                    empty: "කරුණාකර වලංගු URI එකක් එක් කරන්න.",
                        ...
                        sections: {
                            ...
                            logoutURLs: {
                                fields: {
                                    ...
                                    signatureValidation: {
                                        hint: "{{productName}} විසින් 'ඉල්ලීම් වස්තුවක්' තුළ සේවාදායකයින්ගෙන් OIDC " +
