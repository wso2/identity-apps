            ...
            idp: {
                ...
                forms: {
                    ...
                    outboundProvisioningGroups: {
                        heading: "පිටතට යන ප්‍රතිපාදන කණ්ඩායම්",
                        hint: "හැඳුනුම්පත් සපයන්නා ලෙස පිටතට යන ප්‍රතිපාදන කණ්ඩායම් ලෙස තෝරාගෙන එකතු කරන්න\n",
                        label: "සමූහය",
                        placeHolder: "කණ්ඩායම තෝරන්න",
                        popup: {
                            content: "කණ්ඩායම එකතු කරන්න"
                        }
                    },
                    roleMapping: {
                        heading: "භූමිකාව සිතියම්ගත කිරීම",
