        ...
        features: {
            ...
            applications: {
                ...
                myaccount: {
                    ...
                    Confirmation: {
                        enableConfirmation: {
                            content: "මගේ ගිණුම පෙරදසුන් මාදිලියේ ඇති අතර එය නිෂ්පාදනයේදී භාවිතා කිරීම නිර්දේශ නොකරයි. " +
                            "කරුණාකර ප්‍රවේශමෙන් ඉදිරියට යන්න.",
                            heading: "ඔබට විශ්වාසද?",
                            message: "මගේ ගිණුම සබල කරන්න."
                        },
                        disableConfirmation: {
                            content: "ඔබ මගේ ගිණුම අක්‍රිය කළහොත්, ඔබේ සංවිධානයේ පරිශීලකයින්ට ස්වයං සේවා විශේෂාංග වෙත " +
                                "ප්‍රවේශ වීමට නොහැකි වනු ඇත.",
                            heading: "ඔබට විශ්වාසද?",
