...
export const userPortal: UserPortalNS = {
    ...
    placeholders: {
        ...
        sessionStorageDisabled: {
            subtitles: {
                0: "ඔබගේ බ්‍රව්සරයේ සැකසුම් මඟින් දත්ත ගබඩා කිරීමට ඉඩ නොදෙන බව පෙනේ.",
                1: "මෙම යෙදුම නිසියාකාරව ක්‍රියාත්මක වීමට කරුණාකර ඔබගේ බ්‍රව්සරයේ දත්ත ගබඩා කිරීම සක්‍රීය කරන්න."
            },
            title: "ඔබගේ බ්‍රව්සරය දත්ත ගබඩා කිරීමට ඉඩ නොදේ"
        }
    },
    sections: {
        accountRecovery: {
