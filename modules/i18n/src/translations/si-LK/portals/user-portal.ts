    ...
    components: {
        ...
        profile: {
            ...
            messages: {
                ...
                mobileConfirmation: {
                    content: {
                        addMobileNumber: "ජංගම දුරකථන යාවත්කාලීන කිරීම තහවුරු කිරීමට කරුණාකර මෙහි ක්ලික් කරන්න.",
                        updateMobileNumber: "ජංගම දුරකථන යාවත්කාලීන කිරීම තහවුරු කිරීමට කරුණාකර මෙහි ක්ලික් කරන්න. " +
                            "අපේක්ෂිත ජංගම දුරකථන අංකය සාර්ථකව සත්‍යාපනය වන තුරු, කලින් සත්‍යාපනය කළ ජංගම දුරකථන අංකය " +
                            "{{mobileNumber}} භාවිතා කරනු ඇත.",
                    },
                    header: "තහවුරු කිරීම අපේක්ෂිතයි!",
                    unverified: "(තහවුරු නොකළ)"
                }
            },
            notifications: {
