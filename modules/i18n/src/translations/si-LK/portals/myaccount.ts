    ...
    components: {
        ...
        consentManagement: {
            editConsent: {
                ...
                description: "සටහන",
                piiCategoryHeading: "ඇප් එක සමඟ ඔබේ පුද්ගලික තොරතුරු එකතු කිරීම සහ බෙදා ගැනීම සඳහා කැමැත්ත කළමනාකරණය කරන්න. ඔබට අවලංගු කිරීමට අවශ්‍ය ගුණාංග ඉවත් කර යාවත්කාලීන සුරැකීමට යාවත්කාලීන බොත්තම ඔබන්න. සියලු ගුණාංග සඳහා කැමැත්ත ඉවත් කිරීමට අවලංගු කිරීමේ බොත්තම ඔබන්න.",
                state: "තත්වය",
                version: "පිටපත"
            },
            modals: {
                consentRevokeModal: {
                    ...
                    message: "මෙම මෙහෙයුම ආපසු හැරවිය නොහැක. මෙය සියලු ගුණාංග සඳහා වන කැමැත්ත ස්ථිරවම අවලංගු කරනු ඇත. ඔබට ඉදිරියට යාමට අවශ්‍ය බව ඔබට විශ්වාසද?",
        ...
        policyConsentManagement: {
            ...
            dangerZones: {
                revoke: {
                    ...
                    subheader: "මෙම ක්‍රියාව ඔබගේ ඉල්ලුම අනුසාරයෙන් මෙම ප්‍රතිපත්තිය සඳහා වන අනුමැතිය අවලංගු කරනු ඇත. ඔබ ඊළඟ වතාවට සේවාවට ප්‍රවේශ වන විට නැවත අනුමැතිය දීමට ඔබෙන් ඉල්ලා සිටින්න පුළුවන්."
                }
            },
            notifications: {
                fetch: {
