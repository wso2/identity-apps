    ...
    components: {
        ...
        mfa: {
            authenticatorApp: {
                ...
                configuredDescription: "සාධක දෙකක සත්‍යාපනය සඳහා ඔබේ වින්‍යාසගත " +
                    "සත්‍යාපන යෙදුමෙන් ඔබට TOTP කේත භාවිතා කළ හැකිය. ඔබට යෙදුමට " +
                    "ප්‍රවේශය නොමැති නම් ඔබට මෙතැනින් අලුත් එකක් මැකීමට හෝ සැකසීමට හැකිය.",
                heading: "සත්‍යාපන යෙදුම",
                hint: "QR කේතය පෙන්වන්න",
                deleteHint: "ඔබේ TOTP සත්‍යාපන යන්ත්‍රය මකන්න",
                modals: {
                    ...
                    delete : {
                        heading: "තහවුරු කිරීම",
                        message: "මෙම ක්‍රියාව මඟින් වින්‍යාස කළ TOTP සත්‍යාපකය ඉවත් කරයි. " +
                    ...
                    inputs: {
                        email: {
                            ...
                            validations: {
                                ...
                                invalidFormat: "විද්‍යුත් තැපැල් ආකෘතිය නිවැරදි නොවේ. ඔබට අක්ෂරාංක, යුනිකෝඩ් අක්ෂර, ඉරි (-), "+
