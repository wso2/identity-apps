                    ...
                    form: {
                        dropdown: {
                            filterAttributeOptions: {
                                ...
                                country: string;
                                displayName: string;
                                failedLockoutCount: string;
                                mobile: string;
                                userSourceId: string;
                                nickName: string;
                                lockedReason: string;
                                fullName: string;
                                nameHonoricPrefix: string;
                                imSkype: string;
                                address: string;
                                region: string;
                                totpEnabled: string;
                                ...
                                failedBackupCodeAttempts: string;
                                accountLocked: string;
                                emailsOtherEmail: string;
                                department: string;
                                photoUrl: string;
                                im: string;
                                postalCode: string;
                                email: string;
                                roles: string;
                                tenantAdminAskPassword: string;
                                organization: string;
                                emailsWorkEmail: string;
                                url: string;
                                addressLocality: string;
                                unlockTime: string;
                                backupCodeEnabled: string;
                                phoneNumbersWorkPhoneNumber: string;
                                failedEmailOtpAttempts: string;
                                nameHonoricSuffix: string;
                                preferredMfaOption: string;
                                phoneNumbersFaxNumber: string;
                                lastModifiedTime: string;
                                nameFormattedName: string;
                                readOnlyUser: string;
                                disableSmsOtp: string;
                                askPassword: string;
                                phoneNumbersHomePhoneNumber: string;
                                failedPasswordRecoveryAttempts: string;
                                userId: string;
                                ...
                                failedAttemptsBeforeSuccess: string;
                                websiteUrl: string;
                                phoneNumbers: string;
                                birthDate: string;
                                phoneNumbersOther: string;
                                userPrincipal: string;
                                emailsHomeEmail: string;
