...
import { IdentityAppsError } from "./identity-apps-error";

/**
 * Error class for the identity apps API exceptions.
 */
export class IdentityAppsAPIError extends IdentityAppsError {
