...
/**
 * @typedef {Object} MyAccountBuildModeInterface
...
/**
 * Resolve build mode flags and output paths for My Account app.
 *
 * @param {Record<string, string | undefined>} env - Environment variables.
 * @returns {MyAccountBuildModeInterface}
 */
function resolveBuildMode(env = {}) {
    ...
    return {
        ...
        outDir: isStatic && isPreAuthCheckEnabled
            ? `build/myaccount/${resolvedAppBasePath}`
            : "build/myaccount",
        publicBase
    };
}
