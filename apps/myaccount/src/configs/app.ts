...
export class Config {
    ...
    public static getServiceResourceEndpoints(): ServiceResourceEndpointsInterface {
        return {
            ...
            typingDNAMe: `${this.getDeploymentConfig().serverOrigin}/api/typingdna/v1.0/me/typingpatterns`,
            typingDNAServer: `${this.getDeploymentConfig().serverOrigin}/api/typingdna/v1.0/server/typingdnaConfig`,
