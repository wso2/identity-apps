...
export class Config {
    ...
    public static getServiceResourceEndpoints(): ServiceResourceEndpointsInterface {
        return {
            ...
            approvals: `${this.getDeploymentConfig()?.serverHost}/api/users/v2/me/approval-tasks`,
            ...
            consentMgtV2: {
                ...
                purposes: `${this.getDeploymentConfig()?.serverHost}/api/identity/consent-mgt/v2.0/purposes`
            },
