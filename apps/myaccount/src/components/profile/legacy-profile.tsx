 ...
 * Also see {@link LegacyProfile.defaultProps}
 */
interface LegacyProfileProps extends SBACInterface<FeatureConfigInterface>, TestableComponentInterface {
 ...
 */
export const LegacyProfile: FunctionComponent<LegacyProfileProps> = (props: LegacyProfileProps): ReactElement => {
    const {
