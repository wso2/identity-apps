...
const VerificationSuccessStep: FunctionComponent<VerificationSuccessStepPropsInterface> = (
    {
        verificationChannel,
        onClose,
        ["data-componentid"]: componentId = "verification-success-step"
    }: VerificationSuccessStepPropsInterface
): ReactElement => {
                    ...
                    <div className="modal-input">
                        ...
                        <p>
                            { t(`myAccount:components.verificationOnUpdate.modal.${
                                verificationChannel.toLowerCase()}.step3.content`) }
                        </p>
                    </div>
                </Segment>
            </Modal.Content>
