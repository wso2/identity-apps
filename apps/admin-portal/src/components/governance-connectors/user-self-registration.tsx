...
export const UserSelfRegistration: FunctionComponent<UserSelfRegistrationProps> = (
    ...
    const handleUpdateError = (error) => {
        if (error.response && error.response.data && error.response.data.detail) {
            dispatch(addAlert({
                description: t("adminPortal:components.serverConfigs.selfRegistration.notifications." +
                    "updateConfigurations.error.description", { description: error.response.data.description }),
                level: AlertLevels.ERROR,
                message: t("adminPortal:components.serverConfigs.selfRegistration.notifications.updateConfigurations." +
                    "error.message")
            }));
        } else {
    ...
    const handleRetrievalError = (error) => {
        if (error.response && error.response.data && error.response.data.detail) {
            dispatch(addAlert({
                ...
                level: AlertLevels.ERROR,
                message: t("adminPortal:components.serverConfigs.selfRegistration.notifications." +
    ...
    const saveSelfRegistrationConfigs = (key, value) => {
        ...
        switch (key) {
            case ServerConfigurationsConstants.SELF_REGISTRATION_ENABLE:
                successNotification.description = t("adminPortal:components.serverConfigs.selfRegistration." +
            ...
            <Grid padded={ true } className="middle aligned">
                <Grid.Row columns={ 2 } className="inner-list-item">
                    <Grid.Column className="first-column" mobile={ 14 } tablet={ 14 } computer={ 14 } >
                        <label>{ t("adminPortal:components.serverConfigs.selfRegistration.form.enable.label") }</label>
                    </Grid.Column>
                ...
                <Grid.Row columns={ 2 } className="inner-list-item">
                    <Grid.Column className="first-column" mobile={ 14 } tablet={ 14 } computer={ 14 } >
                        <label className={ selfSignUpConfigs?.enable?.length > 0 ? "" : "meta" }>
                            { t("adminPortal:components.serverConfigs.selfRegistration.form." +
                ...
                <Grid>
                    <Grid.Row columns={ 1 }>
                        <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                            <Divider/>
                            <Field
                                label={ t("adminPortal:components.serverConfigs.selfRegistration.form." +
                                    "verificationLinkExpiryTime.label") }
                                name={ ServerConfigurationsConstants.VERIFICATION_CODE_EXPIRY_TIME }
                                placeholder={ t("adminPortal:components.serverConfigs.selfRegistration.form." +
                                    "verificationLinkExpiryTime.placeholder") }
                                required={ true }
                                requiredErrorMessage={ t("adminPortal:components.serverConfigs.selfRegistration.form." +
                    ...
                    <Grid.Row columns={ 1 }>
                        <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                            <Field
                                ...
                                required={ true }
                                requiredErrorMessage={ t("adminPortal:components.serverConfigs.selfRegistration." +
                            ...
                            />
                            <Hint>
                                { t("adminPortal:components.serverConfigs.selfRegistration.form.smsOTPExpiryTime.hint") }
                            </Hint>
                        </Grid.Column>
                    </Grid.Row>
                    <Grid.Row columns={ 1 }>
    ...
    return (
        <Section
            description={ t("adminPortal:components.serverConfigs.selfRegistration.description") }
            header={ t("adminPortal:components.serverConfigs.selfRegistration.heading") }
