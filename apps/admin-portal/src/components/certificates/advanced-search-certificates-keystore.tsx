 ...
 */
interface CertificatesKeystoreSearchPropsInterface {
 ...
 * @return {JSX.Element}
 */
export const CertificatesKeystoreSearch: FunctionComponent<CertificatesKeystoreSearchPropsInterface> = (
    props: CertificatesKeystoreSearchPropsInterface
): JSX.Element => {
