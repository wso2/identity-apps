...
export const UserSearch: FunctionComponent<UserSearchProps> = (
    ...
    return (
        <AdvancedSearch
            searchFieldTestId="user_mgt_user_list_user_search_input"
            clearSearchButtonTestId="user_mgt_user_list_user_search_clear_button"
            showOptionsButtonTestId="user_mgt_user_list_user_search_options_button"
            aligned="left"
                    ...
                    <Grid.Column width={ 16 }>
                        ...
                        >
                            <Field
                                ...
                                placeholder={ t("devPortal:components.users.search.forms.searchForm.inputs" +
                                    ".filerAttribute.placeholder") }
                                required={ true }
                                requiredErrorMessage={ t("devPortal:components.users.search.forms.searchForm" +
