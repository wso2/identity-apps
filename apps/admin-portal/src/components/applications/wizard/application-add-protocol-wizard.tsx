...
import { createApplication, getApplicationTemplateData, updateApplicationConfigurations } from "../../../api";
 ...
 */
interface ApplicationProtocolAddWizardPropsInterface {
    currentStep?: number;
    title: string;
    closeWizard: () => void;
 ...
 *
 * @param {ApplicationProtocolAddWizardPropsInterface} props - Props injected to the component.
 * @return {React.ReactElement}
 */
export const ApplicationProtocolAddWizard: FunctionComponent<ApplicationProtocolAddWizardPropsInterface> = (
    props: ApplicationProtocolAddWizardPropsInterface
): ReactElement => {
    ...
    useEffect(() => {
        ...
        // if (addProtocol && wizardSteps[currentWizardStep]?.name === WizardStepsFormTypes.PROTOCOL_SETTINGS) {
        //     setTriggerProtocolSelectionSubmit(false);
        //     setCurrentWizardStep(currentWizardStep - 1);
        // } else {
        //     setCurrentWizardStep(currentWizardStep - 1);
 ...
 */
ApplicationProtocolAddWizard.defaultProps = {
    currentStep: 0
};
