...
import { Hint, Section, URLInput } from "@wso2is/react-components";
...
export const RealmConfiguration: FunctionComponent<RealmConfigurationProps> = (
    ...
    const handleUpdateError = (error): void => {
        if (error.response && error.response.data && error.response.data.detail) {
            dispatch(addAlert({
                description: t("adminPortal:components.serverConfigs.realmConfiguration.notifications." +
                    "updateConfigurations.error.description", { description: error.response.data.description }),
                level: AlertLevels.ERROR,
                message: t("adminPortal:components.serverConfigs.realmConfiguration.notifications" +
                ...
                <Grid.Row columns={ 1 } className="pl-3">
                    <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                        <URLInput
                            ...
                            labelName={
                                t("adminPortal:components.serverConfigs.realmConfiguration.form." +
                ...
                <Grid.Row columns={ 1 } className="pl-3">
                    <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                        <Field
                            ...
                            label={ t("adminPortal:components.serverConfigs.realmConfiguration." +
                                "form.idleSessionTimeoutPeriod.label") }
                        />
                        <Hint>
                            { t("adminPortal:components.serverConfigs.realmConfiguration." +
    ...
    return (
        <Section
            description={ t("adminPortal:components.serverConfigs.realmConfiguration.description") }
            header={ t("adminPortal:components.serverConfigs.realmConfiguration.heading") }
