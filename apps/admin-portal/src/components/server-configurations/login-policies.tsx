...
export const LoginPolicies: FunctionComponent<LoginPoliciesProps> = (
    ...
    const handleUpdateError = (error) => {
        if (error.response && error.response.data && error.response.data.detail) {
            dispatch(addAlert({
                description: t("adminPortal:components.serverConfigs.loginPolicies.notifications." +
                    "updateConfigurations.error.description", { description: error.response.data.description }),
                level: AlertLevels.ERROR,
                message: t("adminPortal:components.serverConfigs.loginPolicies.notifications.updateConfigurations." +
                    "error.message")
            }));
        } else {
    ...
    const handleRetrievalError = (error) => {
        if (error.response && error.response.data && error.response.data.detail) {
            dispatch(addAlert({
                ...
                level: AlertLevels.ERROR,
                message: t("adminPortal:components.serverConfigs.loginPolicies.notifications." +
    ...
    const saveLoginPoliciesConfigs = (key, value) => {
        ...
        switch (key) {
            case ServerConfigurationsConstants.ACCOUNT_LOCK_ENABLE:
                successNotification.description = t("adminPortal:components.serverConfigs.loginPolicies." +
        ...
        <Grid className="middle aligned mt-1">
            <Grid.Row columns={ 2 } className="inner-list-item mt-3 mb-3">
                ...
                <Grid.Column mobile={ 15 } tablet={ 15 } computer={ 15 }>
                    <Field
                        label={ t("adminPortal:components.serverConfigs.loginPolicies.accountLock." +
                            "form.maxFailedLoginAttemptsToAccountLock.label") }
                        name={ ServerConfigurationsConstants.MAX_FAILED_LOGIN_ATTEMPTS_TO_ACCOUNT_LOCK }
                        placeholder={ t("adminPortal:components.serverConfigs.loginPolicies." +
                            "accountLock.form.maxFailedLoginAttemptsToAccountLock.placeholder") }
                        required={ true }
                        requiredErrorMessage={ t("adminPortal:components.serverConfigs.loginPolicies." +
                    ...
                    <Hint disabled={ !loginPoliciesConfigs?.accountLockEnable }>
                        { t("adminPortal:components.serverConfigs.loginPolicies.accountLock." +
                ...
                <Grid className="middle aligned mt-1">
                    <Grid.Row columns={ 3 } className="inner-list-item">
                        <Grid.Column className="first-column pl-3" mobile={ 14 } tablet={ 14 } computer={ 14 } >
                            { t("adminPortal:components.serverConfigs.loginPolicies." +
            ...
            <Grid.Row columns={ 2 } className="inner-list-item mt-3 mb-3">
                ...
                <Grid.Column mobile={ 15 } tablet={ 15 } computer={ 15 }>
                    <Field
                        ...
                        children={ [
                            {
                                label: t("adminPortal:components.serverConfigs.loginPolicies." +
                        ...
                        <Grid.Column className="first-column" mobile={ 12 } tablet={ 12 } computer={ 12 }>
                            <Icon
                                ...
                                color={ (loginPoliciesConfigs.accountDisablingEnable?.length > 0 &&
                                    ...
                                    ? "orange" : "grey" }
                            />
                            { t("adminPortal:components.serverConfigs.loginPolicies.accountDisable." +
                ...
                <Grid>
                    <Grid.Row columns={ 1 }>
                        <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                            <Field
                                ...
                                requiredErrorMessage=""
                                default={ "" }
                                label={ t("adminPortal:components.serverConfigs.loginPolicies.reCaptcha." +
                    ...
                    <Grid.Row columns={ 1 }>
                        <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 14 }>
                            ...
                            />
                            <Hint>
                                { t("adminPortal:components.serverConfigs.loginPolicies.reCaptcha." +
    ...
    return (
        <Section
            description={ t("adminPortal:components.serverConfigs.loginPolicies.description") }
            header={ t("adminPortal:components.serverConfigs.loginPolicies.heading") }
