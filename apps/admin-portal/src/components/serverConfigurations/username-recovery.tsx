 ...
 */
interface UsernameRecoveryProps {
 ...
 *
 * @param {UsernameRecoveryProps} props - Props injected to the change password component.
 * @return {JSX.Element}
 */
export const UsernameRecovery: FunctionComponent<UsernameRecoveryProps> = (props: UsernameRecoveryProps): JSX.Element => {
