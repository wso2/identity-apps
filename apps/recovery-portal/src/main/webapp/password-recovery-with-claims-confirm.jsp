...
<%@ page import="org.wso2.carbon.identity.mgt.endpoint.util.client.model.passwordrecovery.v1.ConfirmRequest" %>
<%@ page import="org.apache.commons.collections.map.HashedMap" %>
<%@ page import="java.util.Map" %>
<%@ page import="org.wso2.carbon.identity.mgt.endpoint.util.client.model.passwordrecovery.v1.ResetCodeResponse" %>
<jsp:directive.include file="includes/localize.jsp"/>

<%
    String confirmationCode = IdentityManagementEndpointUtil.getStringValue(request.getParameter("confirmation"));
    String callback = IdentityManagementEndpointUtil.getStringValue(request.getParameter("callback"));
    String resetCode = "";
    String tenantDomain = IdentityManagementEndpointUtil.getStringValue(
            request.getParameter(IdentityManagementEndpointConstants.TENANT_DOMAIN));
