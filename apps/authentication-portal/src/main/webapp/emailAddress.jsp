			...
			<main class="center-segment">
				<div class="ui container medium center aligned middle aligned">
					...
					<div class="ui segment">
						<!-- page content -->
						<h2><%=AuthenticationEndpointUtil.i18n(resourceBundle, "enter.email")%></h2>
						...
						<div class="segment-form">
							<form class="ui large form" id="pin_form" name="pin_form"
								...
								<div class="align-right buttons">
									<input type="button" name="update" id="update" value="<%=AuthenticationEndpointUtil.i18n(resourceBundle, "update.email")%>"
