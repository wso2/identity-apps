            ...
            <div>
                ...
                <div>
                    ...
                    <div id="cookiePolicy">
                        ...
                        <p>The primary purpose of some cookies used in WSO2 IS is to personally identify you as this is the main function of the <jsp:directive.include file="product-name.jsp"/>. However the cookie lifetime ends once your session ends i.e., after you log-out, or after the session expiry time has elapsed.</p>
