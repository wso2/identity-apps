        ...
        <main class="center-segment">
            <div class="ui container medium center aligned middle aligned">
                ...
                <div class="ui segment">
                    <!-- page content -->
                    <h2><%=AuthenticationEndpointUtil.i18n(resourceBundle, "otp.verification")%></h2>
                    ...
                    <div class="segment-form">
                        <form class="ui large form" id="codeForm" name="codeForm" action="../commonauth" method="POST">
                            ...
                            <% } else { %>
                            <div class="field">
                                <label for="password"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "enter.code")%>:</label>
                            ...
                            <div class="align-right buttons">
                                <%
                                    if ("true".equals(authenticationFailed)) {
                                %>
                                <a class="ui button link-button" id="resend"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "resend.code")%></a>
                                <% } %>
                                <input type="button" name="authenticate" id="authenticate" value="<%=AuthenticationEndpointUtil.i18n(resourceBundle, "authenticate")%>"
