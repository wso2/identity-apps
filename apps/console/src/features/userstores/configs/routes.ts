...
/**
 * Userstore Management feature Routes array.
 *
 * @remarks
 ...
 *  }
 */
export const USERSTORE_FEATURE_ROUTES: RouteInterface[] = [
    {
        category: "adminPortal:components.sidePanel.categories.userstores",
        children: [
            {
                component: lazy(() => import("../pages/user-stores-edit")),
                icon: {
                    icon: SidePanelIcons.childIcon
                },
                id: "edit-user-store",
                name: "adminPortal:components.sidePanel.editUserstore",
                path: RoutingConstants.PATHS.get("USERSTORES_EDIT"),
                protected: true,
                showOnSidePanel: false
            },
            {
                component: lazy(() => import("../pages/userstores-templates")),
                icon: {
                    icon: SidePanelIcons.childIcon
                },
                id: "userstore-templates",
                name: "adminPortal:components.sidePanel.userstoreTemplates",
                path: RoutingConstants.PATHS.get("USERSTORE_TEMPLATES"),
                protected: true,
                showOnSidePanel: false
            }
        ],
        component: lazy(() => import("../pages/user-stores")),
        icon: {
        ...
        order: 3,
        path: RoutingConstants.PATHS.get("USERSTORES"),
        protected: true,
