...
/**
 * Certificates Management feature Routes array.
 *
 * @remarks
 ...
 *  }
 */
export const CERTIFICATES_FEATURE_ROUTES: RouteInterface[] = [
    {
        category: "adminPortal:components.sidePanel.categories.certificates",
        component: lazy(() => import("../pages/certificates-keystore")),
        icon: {
        ...
        order: 4,
        path: RoutingConstants.PATHS.get("CERTIFICATES"),
        protected: true,
