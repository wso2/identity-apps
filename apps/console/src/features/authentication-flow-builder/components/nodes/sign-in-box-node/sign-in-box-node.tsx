    ...
    const generateDynamicSignInOption = (option: AuthenticatorInterface): ReactElement => {
        ...
        return (
            <div className="oxygen-sign-in-option with-cancel-button">
                <Tooltip title={ t("loginFlow:options.controls.remove") }>
                    <IconButton
                        size="small"
                ...
                >
                    {
                        authenticator.displayName.startsWith("Sign In With")
                            ...
                            : t("loginFlow:options.displayName", { displayName: authenticator.displayName })
                    }
                </Button>
            </div>
        );
        ...
        if (activeBasicSignInOption === IdentityProviderManagementConstants.BASIC_AUTHENTICATOR) {
            return (
                <>
                    ...
                    />
                    <Divider>{ t("loginFlow:options.divider") }</Divider>
                </>
            );
        }
                    ...
                    <Box className="oxygen-sign-in-form">
                        ...
                        <div className="oxygen-sign-in-options-wrapper">
                            <div className="oxygen-sign-in-options">
                                ...
                                ) }
                                {
                                    ...
                                    >
                                        { t("loginFlow:steps.controls.addOption") }
                                    </Button>)
                                }
                            </div>
                        </div>
                        { showSelfSignUp && (
                            <Grid container className="oxygen-sign-in-sign-up-link">
                                <Grid>{ t("loginFlow:steps.controls.signUp.hint") }</Grid>
                                <Grid>
                                    <Link href="#" className="oxygen-sign-in-sign-up-link-action">
                                        { t("loginFlow:steps.controls.signUp.label") }
                                    </Link>
                                </Grid>
                            </Grid>
                        ) }
            ...
            <FormGroup className="additional-behaviors">
                { signInStepConfigsVisibility[0] && (
                    <>
                        <FormControlLabel
                            ...
                            label={ t("loginFlow:nodes.controls.userAttributeSelector.label") }
                        ...
                        <FormControlLabel
                            ...
                            label={ t("loginFlow:nodes.controls.attributeSelector.label") }
                ...
                { signInStepConfigsVisibility[1] && (
                    <FormControlLabel
                        ...
                        label={ t("loginFlow:nodes.controls.enableBackupCodes.label") }
