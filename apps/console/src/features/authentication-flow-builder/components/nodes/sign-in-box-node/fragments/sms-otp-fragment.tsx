    ...
    return (
        <div className="sms-otp-fragment" data-componentid={ componentId }>
            <Typography align="center" className="oxygen-sign-in-header" variant="h4">
                { t("loginFlow:nodes.smsOTP.header") }
            </Typography>
            <BasicSignInOptionControls
                ...
                optionRemoveTooltipContent={ t("loginFlow:nodes.smsOTP.controls.optionRemoveTooltipContent") }
            >
                <Typography align="left" className="oxygen-sign-in-sub-header" variant="subtitle1">
                    { t("loginFlow:nodes.smsOTP.form.fields.code.label") }
                </Typography>
            ...
            <div className="oxygen-sign-in-action-group">
                <Button
                    ...
                    fullWidth
                >
                    { t("loginFlow:nodes.smsOTP.form.actions.primary") }
                </Button>
                <Button
                    color="secondary"
                    variant="contained"
                    ...
                    fullWidth
                >
                    { t("loginFlow:nodes.smsOTP.form.actions.secondary") }
                </Button>
            </div>
        </div>
    );
