...
export class OrganisationConstants {
    ...
    /**
     * Default organisation list attributes.
     * @constant
     * @type {string[]}
     * @default
     */
    public static readonly DEFAULT_ORG_LIST_ATTRIBUTES = [ "Type", "country", "locale", "segment", "source" ];

    /**
     * Default role list attributes.
     * @constant
     * @type {string[]}
     * @default
     */
    public static readonly DEFAULT_ROLE_LIST_ATTRIBUTES = [ "name", "userName", "emails" ];
