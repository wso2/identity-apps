 ...
 */
interface OrganisationsListOptionsProps extends  TestableComponentInterface {
    handleMetaColumnChange: (columns: string[]) => void;
    organisationListMetaContent: Map<string, string>;
}
 ...
 * @return {ReactElement}
 */
export const OrganisationListOptionsComponent: React.FunctionComponent<OrganisationsListOptionsProps> = (
    props: OrganisationsListOptionsProps
): ReactElement => {
            ...
            <List relaxed>
                <List.Item>
                    <Field
                        ...
                        value={ [organisationListMetaContent.get("name").toString()] }
                        defaultChecked
                        disabled
                    />
                </List.Item>
                <List.Item>
                    <Field
                        ...
                        value={ [organisationListMetaContent.get("emails").toString()] }
                        defaultChecked
                        disabled
                    />
                </List.Item>
                <List.Item>
                    <Field
                        ...
                        value={ organisationListMetaContent.get("userName")?.toString() ?
                            [organisationListMetaContent.get("userName").toString()] : null }
                    />
                </List.Item>
                <List.Item>
                    <Field
                        ...
                        value={ organisationListMetaContent.get("id")?.toString() ?
                            [organisationListMetaContent.get("id").toString()] : null }
                    />
                </List.Item>
                <List.Item>
                    <Field
                        ...
                        value={ organisationListMetaContent.get("meta.lastModified")?.toString() ? [
                            organisationListMetaContent.get("meta.lastModified").toString()] : null }
                    />
                </List.Item>
                {
                    /*
