...
/**
 * Server Configurations feature Routes array.
 *
 * @remarks
 ...
 *  }
 */
export const SERVER_CONFIGURATIONS_FEATURE_ROUTES: RouteInterface[] = [
    {
        component: lazy(() => import("../pages/governance-connectors")),
        exact: true,
        icon: null,
        id: "governanceConnectors",
        name: "adminPortal:components.sidePanel.governanceConnectors",
        order: 6,
        path: RoutingConstants.PATHS.get("GOVERNANCE_CONNECTORS"),
        protected: true,
