...
interface OrganizationProfileEditPropsInterface {
    orgId: string;
    orgName: string;
    orgDesc: string;
    orgCreated: string;
    orgLastModified: string;
    orgType: string;
    orgDomain: string;
}
...
export const OrganizationProfile: FunctionComponent<OrganizationProfilePropsInterface> = (
    ...
    const handleSubmit = async (values: OrganizationProfileEditPropsInterface): Promise<void> => {
