...
import { Checkbox, Input, Popup, Table } from "semantic-ui-react";
import { ExtendedClaimMappingInterface } from "./attribute-settings";

interface AttributeListItemOIDCPropInterface extends TestableComponentInterface {
    displayName: string;
...
/**
 * All Attribute list item component. Attributes grouped by the scopes.
 */
export const AttributeListItemOIDC: FunctionComponent<AttributeListItemOIDCPropInterface> = (
    props: AttributeListItemOIDCPropInterface
): ReactElement => {
                    ...
                    content={
                        subject ? t("console:develop.features.applications.edit.sections.attributes.selection" +
                            ...
                            requested
                                ...
                                ".mappingTable.listItem.actions.removeRequested")
                                : t("console:develop.features.applications.edit.sections.attributes.selection" +
                                ".mappingTable.listItem.actions.makeRequested")
                    }
                    inverted
                    disabled={
