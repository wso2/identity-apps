...
/**
 * Application Management feature Routes array.
 *
 * @remarks
 ...
 *  }
 */
export const APPLICATIONS_FEATURE_ROUTES: RouteInterface[] = [
    {
        children: [
            {
                component: lazy(() => import("../pages/application-template")),
                exact: true,
                icon: {
                ...
                path: RoutingConstants.PATHS.get("APPLICATION_TEMPLATES"),
                protected: true,
                showOnSidePanel: false
            },
            {
                component: lazy(() => import("../pages/application-edit")),
                exact: true,
                icon: {
                    icon: SidePanelIcons.childIcon
                },
                ...
                path: RoutingConstants.PATHS.get("APPLICATION_EDIT"),
                protected: true,
                showOnSidePanel: false
            }
        ],
        ...
        path: RoutingConstants.PATHS.get("APPLICATIONS"),
        protected: true,
