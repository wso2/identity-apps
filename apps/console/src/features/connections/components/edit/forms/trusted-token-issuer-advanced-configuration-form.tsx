        ...
        >
            ...
            <div>
                ...
                <Dropdown
                    ...
                    error={ implicitAssociationEnabled && (selectedClaims.length > 5 || selectedClaims.length === 0) }
                />
                <Hint>
                    { t("console:develop.features.idp.forms.advancedConfigs." +
            ...
            <Field.Button
                ...
                disabled={ implicitAssociationEnabled && (selectedClaims.length === 0 || selectedClaims.length > 5) }
