...
/**
 * The interface for WSFederation config form.
 */
export interface WSFederationConfigFormValuesInterface {
...
/**
 * The interface of the API response for WSFederation config editing.
 */
