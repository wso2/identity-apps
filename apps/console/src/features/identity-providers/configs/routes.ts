...
/**
 * IDP Management feature Routes array.
 *
 * @remarks
 ...
 *  }
 */
export const IDP_FEATURE_ROUTES: RouteInterface[] = [
    {
        children: [
            {
                component: lazy(() => import("../pages/identity-provider-template")),
                exact: true,
                icon: {
                ...
                path: RoutingConstants.PATHS.get("IDP_TEMPLATES"),
                protected: true,
                showOnSidePanel: false
            },
            {
                component: lazy(() => import("../pages/identity-provider-edit")),
                exact: true,
                icon: {
                    icon: SidePanelIcons.childIcon
                },
                ...
                path: RoutingConstants.PATHS.get("IDP_EDIT"),
                protected: true,
                showOnSidePanel: false
            }
        ],
        component: lazy(() => import("../pages/identity-providers")),
        exact: true,
        icon: {
        ...
        path: RoutingConstants.PATHS.get("IDP"),
        protected: true,
