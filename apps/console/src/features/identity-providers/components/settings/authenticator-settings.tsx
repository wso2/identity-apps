            ...
            if (authenticator.id === IdentityProviderManagementConstants.OIDC_AUTHENTICATOR_ID) {
                ...
                authenticator.meta.properties.map(prop => {
                    if (prop.key === "ClientId") {
                        ...
                        prop.displayName = "Authorized redirect URL";
                        prop.description = "The Asgardeo URL to which the user needs to be redirected after completing the authentication at the " +
                            "identity provider. The identity provider needs to send the authorization code to this URL upon successful authentication.";
                        prop.readOnly = true;
