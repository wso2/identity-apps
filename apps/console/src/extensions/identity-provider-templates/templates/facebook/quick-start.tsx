            ...
            stepContent: (
                <>
                    <Text>
                        <Trans
                            i18nKey={
                                "extensions:develop.identityProviders.facebook.quickStart.steps.selectApplication.content"
                            }
                        >
        ...
        },
        {
            stepContent: (
                <>
                    <Text>
                        <Trans
                            i18nKey={ "extensions:develop.identityProviders.facebook.quickStart.steps.selectDefaultConfig " +
                            ".content" }
                        >
            ...
            stepTitle: (
                <Trans i18nKey="extensions:develop.identityProviders.facebook.quickStart.steps.selectDefaultConfig.heading">
        ...
        },
        {
            stepContent: (
                <>
                    <Text>
                        <Trans
                            i18nKey="extensions:develop.identityProviders.facebook.quickStart.steps.customizeFlow.content"
                        >
