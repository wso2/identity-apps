...
export const extensions: Extensions = {
    develop: {
        ...
        emailProviders: {
            ...
            description: "Configure organization specific SMTP settings. If unconfigured, the server level settings will apply.",
            note: "SMTP settings for the super organization can only be configured via server level settings.",
