                ...
                advance: {
                    links: {
                        fields: {
                            ...
                            recoveryPortalURL: {
                                hint: "Link to your organization's recovery portal URL. This link will be used only within flow builders. You can use placeholders like <1>{{lang}}</1>, <3>{{country}}</3>, or <5>{{locale}}</5> to customize the URL for different regions or languages.",
