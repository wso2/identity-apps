...
export const extensions: Extensions = {
    ...
    develop: {
        ...
        emailProviders: {
            ...
            note: "සුපිරි සංවිධානය සඳහා ඊමේල් සපයන්නාගේ වින්‍යාස කිරීම් යාවත්කාලීන කළ හැක්කේ <1>deployment.toml</1> හරහා පමණි",
                            ...
                            content: {
                                parameters: {
                                    progressiveEnrollment: {
                                        ...
                                        note: "මුර යතුර පළමු සාධකය ලෙස සකසා ඇත්නම්, යෙදුමේ <3>පිවිසීමේ ක්‍රමය</3> " +
                                        "ටැබය යටතේ පහත <1> අනුවර්තන ස්ක්‍රිප්ට්</1> එක් කළ යුතුය. " +
                                        "මෙම ස්ක්‍රිප්ටය සැකිල්ල මත පදනම් වූ මුරපද සැකසුම සමඟ ස්වයංක්‍රීයව " +
                                        "එකතු වන අතර මුරපද ලියාපදිංචි කිරීමට පෙර පරිශීලකයාගේ අනන්‍යතාවය " +
                                        "තහවුරු කිරීමට භාවිතා කරයි. කෙසේ වෙතත්, ඔබ අච්චුවක් නොමැතිව මුරපද " +
                                        "වින්‍යාස කරන්නේ නම්, ස්ක්‍රිප්ට් එක හස්තීයව එක් කිරීමට මතක තබා ගන්න."
                                    },
            ...
            user: {
                addUser: {
                    ...
                    validation: {
                        ...
                        usernameSpecialCharHint: "අක්ෂර {{minLength}} සිට {{maxLength}} දක්වා දිගු විය යුතු අතර අකුරු (a-z, A-Z), ඉලක්කම් (0-9) " +
                            "සහ පහත දැක්වෙන අනුලකුණු වල සංකලනයක් පමණක් අඩංගු විය හැක: !@#$%&'*+\\=?^_`.{|}~-.",
