...
export const extensions: Extensions = {
    ...
    develop: {
        ...
        emailProviders: {
            ...
            goBack: "දැනුම්දීම් නාලිකා වෙත ආපසු යන්න",
            confirmationModal: {
                assertionHint: "කරුණාකර ඔබගේ ක්‍රියාව තහවුරු කරන්න.",
        ...
        smsProviders: {
            ...
            description: "ඔබගේ SMS සපයන්නාට අනුව පහත සැකසුම් වින්‍යාස කරන්න.",
                            ...
                            content: {
                                parameters: {
                                    progressiveEnrollment: {
                                        ...
                                        "මෙම ස්ක්‍රිප්ටය මුර යතුරු ලියාපදිංචි කිරීමට පෙර පරිශීලකයාගේ අනන්‍යතාවය " +
                                        "තහවුරු කිරීමට භාවිතා කරන අතර එය සැකිල්ල මත පදනම් වූ මුරපද සැකසුම " + 
                                        "සමඟ ස්වයංක්‍රීයව ඇතුළත් වේ. කෙසේ වෙතත්, ඔබ අච්චුවක් නොමැතිව මුරපද " + 
                                        "වින්‍යාස කරන්නේ නම්, ස්ක්‍රිප්ට් එක හස්තීයව එක් කිරීමට මතක තබා ගන්න."
                                    },
                                    usernamelessAuthentication: {
                                        description: "මෙම විශේෂාංගය සක්‍රීය කිරීමෙන් පරිශීලකයින්ට ඔවුන්ගේ පරිශීලක " + 
