...
export const views: Views = {
                   ...
                   emailRecovery: {
                       ...
                       notifications: {
                           updateEmail: {
                               ...
                               success: {
                                   description:
                                       "பயனர் விபரக்கோவையில் உள்ள மின்னஞ்சல் முகவரி புதுப்பிக்கப்பட்டுவிட்டது.",
               ...
               consentManagement: {
                   modals: {
                       consentRevokeModal: {
                           ...
                           message:
                               "நீங்கள் அனுமதியினை நீக்க விரும்புகிறீர்களா? இச்செயல் மீள் திரும்ப முடியாக்க செயலாகும்."
                       },
                       editConsentModal: {
                           description: {
                   ...
                   notifications: {
                       ...
                       updateConsentedClaims: {
                           ...
                           success: {
                               description:
                                   "செயலியின் அனுமதியளிக்கப்பட்ட கூற்றுக்கள் வெற்றிகரமாக புதுப்பிக்கப்பட்டுவிட்டன",
                   ...
                   smsOtp: {
                       ...
                       notifications: {
                           updateMobile: {
                               error: {
                                   description:
                                       "கையடக்க தொலைபேசி இலக்கத்தினை புதுப்பிக்கும் பொழுது தவறொன்று ஏற்பட்டு விட்டது",
               ...
               privacy: {
                   ...
                   privacyPolicy: {
                       collectionOfPersonalInfo: {
                           description: {
                               list1: {
                                   0: "WSO2 IS uses your IP address to detect any suspicious login attempts" +
                                       " to your account.",
                                   1:
                       ...
                       mobileChangeForm: {
                           inputs: {
                               mobile: {
                                   label: "கையடக்க தொலைபேசி இலக்கம்",
                                   note:
                                       "கவனிக்குக: இது உங்களின் சுயவிபரத்தில் உள்ள கையடக்க தொலைபேசி இலக்கத்தை மாற்றும்",
           ...
           sections: {
               ...
               userSessions: {
                   actionTitles: {
                       empty: "செயற்பாட்டில் உள்ள அமர்வுகள் யாதுமில்லை",
