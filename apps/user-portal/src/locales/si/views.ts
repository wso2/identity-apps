...
export const views: Views = {
                    ...
                    emailResetForm: {
                        inputs: {
                            email: {
                                ...
                                validations: {
                                    empty: "ඊමේල් තැපැල් ලිපිනයක් ඇතුළත් කරන්න"
                                }
                            }
                        }
                    }
    ...
    sections: {
        ...
        approvals: {
            description: "ඔබගේ අනුමැතිය බලාපොරොත්තුවෙන් සිටින කාර්ය ප්‍රවාහ මෙහෙයුම් වලට " +
        ...
        changePassword: {
            ...
            description: "බගේ මුරපදය නිතිපතා යාවත්කාලීන කර එය ඔබ භාවිතා කරන වෙනත් " +
