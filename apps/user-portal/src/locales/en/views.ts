        ...
        privacy: {
            ...
            privacyPolicy: {
                ...
                description: {
                    ...
                    para3: "Entities, organisations or individuals controlling the use and administration of WSO2 IS should create their own privacy policies setting out the manner in which data is controlled or processed by the respective entity, organisation or individual."
                },
                disclaimer: {
                    description: {
                        list1: {
                ...
                disclosureOfPersonalInfo: {
                    ...
                    legalProcess: {
                        description: "Please note that the organisation, entity or individual running WSO2 IS may be compelled to disclose your personal information with or without your consent when it is required by law following due and lawful process.",
                ...
                moreInfo: {
                    changesToPolicy: {
                        description: {
                            ...
                            para2: "The organization running WSO2 IS may revise the Privacy Policy from time to time. You can find the most recent governing policy with the respective link provided by the organization running WSO2 IS 5.5. The organization will notify any changes to the privacy policy over our official public channels."
                        },
                    ...
                    yourChoices: {
                        description: {
                            ...
                            para2: "If you do not have an account and you do not agree with our privacy policy, you can chose not to create one."
                        },
