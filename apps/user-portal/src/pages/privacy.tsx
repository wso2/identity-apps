...
export const PrivacyPage = (): JSX.Element => {
    ...
    return (
        <DefaultPageLayout
            pageTitle={ t("views:pages.privacy.title") }
        >
            <Grid>
                ...
                <Grid.Row columns={ 1 }>
                    <Grid.Column width={ 16 }>
                        ...
                        <List bulleted>
                            ...
                            <List.Item>
                                { t("views:components.privacy.privacyPolicy.collectionOfPersonalInfo.description.list1.1") }
                            </List.Item>
                            <List.Item>
                                { t("views:components.privacy.privacyPolicy.collectionOfPersonalInfo.description.list1.2") }
                            </List.Item>
                        </List>
                ...
                <Grid.Row columns={ 1 }>
                    <Grid.Column width={ 16 }>
                        ...
                        <List bulleted>
                            ...
                            <List.Item>
                                { t("views:components.privacy.privacyPolicy.storageOfPersonalInfo.howLong.description.list1.1") }
                            </List.Item>
                        </List>
                        ...
                        <p>
                            { t("views:components.privacy.privacyPolicy.storageOfPersonalInfo.requestRemoval.description.para1") }
                        </p>
                        <p>
                            { t("views:components.privacy.privacyPolicy.storageOfPersonalInfo.requestRemoval.description.para2") }
                        </p>
                    </Grid.Column>
                </Grid.Row>
