...
var AppUtils = AppUtils || (function() {
    ...
    return {
        ...
        getTenantPath: function() {
            return (this.getTenantName() !== "") ?
                "/" + getTenantPrefix() + "/" + this.getTenantName() : "";
        },

        getConfig: function() {
            return {
                appBase: this.getTenantPath() + "/" + _config.appBaseName,
