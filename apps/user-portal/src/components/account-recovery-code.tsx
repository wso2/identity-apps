 ...
 * @return {JSX.Element}
 */
export const CodeRecovery: React.FunctionComponent<CodeRecoveryProps> = (
    props: CodeRecoveryProps
): JSX.Element => {
            ...
            return (<Grid padded>
                    <Grid.Row columns={2}>
                        <Grid.Column width={11} className="first-column">
                            ...
                            <List.Content>
                                <List.Header>{t("views:accountRecovery.codeRecovery.title")}</List.Header>
                                <List.Description>
                                    {t("views:accountRecovery.codeRecovery.description")}
                                </List.Description>
                            </List.Content>
                        </Grid.Column>
