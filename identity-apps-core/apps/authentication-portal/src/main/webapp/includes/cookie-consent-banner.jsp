...
<%
    if (!StringUtils.isBlank(cookiePolicyURL) && 
        ((Boolean.FALSE.toString()).equals(is_cookiepro_enabled) || 
        ((Boolean.TRUE.toString()).equals(is_cookiepro_enabled) && !StringUtils.equals(tenantForTheming, IdentityManagementEndpointConstants.SUPER_TENANT)))) {
%>
...
<%
    if (!StringUtils.isBlank(cookiePolicyURL) && 
        (Boolean.TRUE.toString()).equals(is_cookiepro_enabled) && 
