...
<%
    ...
    if (enterpriseUserloginEnabled) {
        String enterpriseLoginRedirectUrl = oauth2AuthorizeURL
                + "?idp=" + ENTERPRISE_USER_LOGIN_IDP
                + "&authenticator=" + ENTERPRISE_USER_LOGIN_AUTHENTICATOR
                + "&fidp=EnterpriseIDP"
                + "&org=" + Encode.forUriComponent(userTenantDomain)
        ...
        response.sendRedirect(enterpriseLoginRedirectUrl);
        return;
    }
                            ...
                            %>
                                ...
                                <% } else if (isMicrosoftIdp) { %>
                                    ...
                                    <% } else {
                                        ...
                                        if ("Asgardeo Platform IDP".equals(idpName)) {
                                            logoPath = "libs/themes/wso2is/assets/images/identity-providers/pulse.svg";
                                        }
                                        ...
                                        <div class="social-login blurring social-dimmer">
                                            <div class="field">
                                                <button
                                                    ...
                                                    >
                                                        <img class="ui image" src="libs/themes/wso2is/assets/images/branding/pulse.svg">
                                                        <span>
