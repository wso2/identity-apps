...
<%
    ...
    boolean canRegisterDevice = Boolean.parseBoolean(Encode.forJava(request.getParameter("canRegisterDevice")));
%>
...
<html>
    ...
    <body class="login-portal layout push-auth-portal-layout" data-page="<%= request.getAttribute("pageName") %>">
                        ...
                        <form class="ui large form" id="submitForm" name="submitForm" action="<%=commonauthURL%>" method="POST">
                            ...
                            <div class="buttons">
                                ...
                                <% if (canRegisterDevice) { %>
                                    ...
                                    >
                                        <%=i18n(resourceBundle, customText, "push.register.new.device")%>
                                    </button>
                                <% } %>
        ...
        <script type="text/javascript">
            ...
            const CURRENT_PUSH_AUTH_ID = PUSH_AUTH_URL_PARAMS.get('pushAuthId');
            ...
            $(document).ready(function () {
                ...
                $("#registerNewDeviceLink").click(function () {
                    ...
                    stopPolling();
                    document.getElementById("scenario").value = "MULTIPLE_DEVICE_PROGRESSIVE_ENROLLMENT";
                    $("#submitForm").submit();
                });
            });
