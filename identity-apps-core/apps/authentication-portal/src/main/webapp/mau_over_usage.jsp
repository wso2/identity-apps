...
<% request.setAttribute("pageName", "mau-over-usage"); %>
...
<body class="login-portal layout " data-isResponsePage=true data-isErrorResponse=true data-page="<%= request.getAttribute("pageName") %>">
