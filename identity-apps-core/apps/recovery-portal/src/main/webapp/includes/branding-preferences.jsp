...
<%
    ...
    String productLogoURL = "libs/themes/wso2is/assets/images/branding/is-logo.svg";
    String productLogoAlt = "WSO2 Identity Server Logo";
    String productWhiteLogoURL = "libs/themes/wso2is/assets/images/branding/is-logo-white.svg";
