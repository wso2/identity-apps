...
<%
    org.apache.logging.log4j.LogManager.getLogger().error("password recovery otp start reached");
    ...
    org.apache.logging.log4j.LogManager.getLogger().error("channel : " + channel);
    ...
    if (IdentityManagementEndpointConstants.PasswordRecoveryOptions.SMSOTP.equals(channel)) {
        ...
        org.apache.logging.log4j.LogManager.getLogger().error("recoveryStage : " + recoveryStage);
        switch (recoveryStage) {
            case "INITIATE":
                org.apache.logging.log4j.LogManager.getLogger().error("INITIATING");
                List<UserClaim> userClaims = new ArrayList<UserClaim>();
                org.apache.logging.log4j.LogManager.getLogger().warn(username);
                ...
                try {
                    ...
                    for(AccountRecoveryType x: resp) {
                        org.apache.logging.log4j.LogManager.getLogger().error(x.getMode());
                    ...
                    org.apache.logging.log4j.LogManager.getLogger().error("flawConfirmationCode :" + flawConfirmationCode + " recoveryCode :" + recoveryCode + " channelId :"+channelId+" channelValue:"+channelValue );

                    org.apache.logging.log4j.LogManager.getLogger().error("Reached end successfully");
                    //request.getRequestDispatcher("sms-otp.jsp").forward(request, response);
                } catch (ApiException e) {
                    org.apache.logging.log4j.LogManager.getLogger().error(e.getCode() + " " + e.getResponseBody());
                ...
                try {
                    ...
                    org.apache.logging.log4j.LogManager.getLogger().error(recoveryResponse);
            ...
            case "RESEND":
                ...
                org.apache.logging.log4j.LogManager.getLogger().error("Resend point reached");
                request.getRequestDispatcher("sms-otp.jsp").forward(request, response);
                break;
            case "":
