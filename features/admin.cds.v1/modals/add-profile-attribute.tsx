...
// import { ProfileAttribute } from "../models/profile-schema";
...
//             const prefix = attribute.attribute_name + ".";
//             axios
...
//             value_type: dataType === "options" ? "string" : attribute.value_type,
...
//                         onChange={(_, data: DropdownProps) =>
//                             setAttribute({ ...attribute, mutability: data.value as string })}
//                     />
...
//                         disabled={!attribute.attribute_name?.trim() || isValidName === false}
//                     >
//                         Add
//                     </PrimaryButton>
//                         </Grid.Column>
