...
import { EmptyPlaceholder, LinkButton, ListLayout } from "@wso2is/react-components";
import React, {
    Dispatch,
    FunctionComponent,
    ReactElement,
...
import { AdvancedSearchWithMultipleFilters } from "./advanced-search-with-multiple-filters";
...
/**
 * Searchable, paginated CDS profile list. Rendered by the standalone Profiles
 * page and embedded in the unified Customer Data Profile page.
 */
const ProfilesSection: FunctionComponent<ProfilesSectionPropsInterface> = ({
    shouldFetch = true,
    ["data-componentid"]: componentId = "cds-profiles-section"
}: ProfilesSectionPropsInterface): ReactElement => {
