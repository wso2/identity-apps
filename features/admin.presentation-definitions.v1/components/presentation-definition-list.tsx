...
import {
    ...
    PresentationDefinitionListPropsInterface
 ...
 */
export const PresentationDefinitionList: FunctionComponent<PresentationDefinitionListPropsInterface> = ({
    isLoading,
    list,
    mutateList,
    onAddClick,
...
}: PresentationDefinitionListPropsInterface): ReactElement => {
        ...
        <>
            ...
            { showDeleteConfirmation && (
                <ConfirmationModal
                    ...
                    assertionHint={ t(
                        "presentationDefinitions:list.confirmations.deleteItem.assertionHint"
                    ) }
