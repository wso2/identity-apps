...
> => {
    const requestConfig: RequestConfigInterface = {
        ...
        url: `${store.getState().config.endpoints.smsTemplates}/template-types`
    };

    const { data, error, isValidating, isLoading, mutate } = useRequest<Data, Error>(requestConfig);
...
export default useGetSmsTemplatesList;
