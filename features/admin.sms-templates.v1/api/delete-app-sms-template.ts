...
/**
 * Delete the app-specific SMS template.
 *
        ...
        .then((response: AxiosResponse) => {
            if (response.status !== 204) {
                throw new IdentityAppsApiException(
                    "Error occurred while deleting the app-specific SMS template.",
                    null,
                    response.status,
                    response.request,
                    response,
...
export default deleteAppSmsTemplate;
