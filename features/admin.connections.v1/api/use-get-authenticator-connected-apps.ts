...
import { ConnectedAppsInterface } from "../models/connection";
 ...
 */
export const useGetAuthenticatorConnectedApps = <Data = ConnectedAppsInterface, Error = RequestErrorInterface>(
