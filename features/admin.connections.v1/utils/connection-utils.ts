 ...
 */
export const handleConnectionDeleteError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (
        error.response &&
        error.response.data &&
 ...
 */
export const handleGetConnectionsError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error?.response?.data?.description) {
        store.dispatch(
            addAlert({
 ...
 */
export const handleGetCustomAuthenticatorError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error?.response?.data?.description) {
        store.dispatch(
            addAlert({
                description: I18n.instance.t(
                    "customAuthenticator:notifications.getCustomAuthenticator.error.description",
                    {
                        description: error?.response?.data?.description
                    }
                ),
                level: AlertLevels.ERROR,
                message: I18n.instance.t("customAuthenticator:notifications.getCustomAuthenticator.error.message")
            })
        );
    ...
    store.dispatch(
        addAlert({
            description: I18n.instance.t(
                "customAuthenticator:notifications.getCustomAuthenticator.genericError.description"
            ),
            level: AlertLevels.ERROR,
            message: I18n.instance.t("customAuthenticator:notifications.getCustomAuthenticator.genericError.message")
        })
    );
};
 ...
 */
export const handleGetConnectionTemplateListError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
 ...
 */
export const handleGetConnectionTemplateRequestError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error.response && error.response.data && error.response.data.description) {
        store.dispatch(
            addAlert({
 ...
 * Utility function to handle the error alert of the get connection list request.
 */
export const handleGetConnectionListCallError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error?.response?.data?.description) {
        store.dispatch(
            addAlert({
                description: I18n.instance.t("authenticationProvider:notifications.getIDPList.error.message", {
 ...
 */
export const handleConnectionUpdateError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error.response && error.response.data && error.response.data.description) {
        store.dispatch(
            addAlert({
 ...
 */
export const handleCustomAuthenticatorUpdateError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error?.response?.data?.description) {
        store.dispatch(
            addAlert({
                description: I18n.instance.t(
                    "customAuthenticator:notifications.updateCustomAuthenticator.error.description",
                    { description: error?.response?.data?.description }
                ),
                level: AlertLevels.ERROR,
                message: I18n.instance.t("customAuthenticator:notifications.updateCustomAuthenticator.error.message")
            })
        );
    ...
    store.dispatch(
        addAlert({
            description: I18n.instance.t(
                "customAuthenticator:notifications.updateCustomAuthenticator.genericError.description"
            ),
            level: AlertLevels.ERROR,
            message: I18n.instance.t(
                "customAuthenticator:notifications.updateCustomAuthenticator.genericError.message"
            )
        })
    );
};
 ...
 */
export const handleGetConnectionsMetaDataError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error?.response?.data?.description) {
        store.dispatch(
            addAlert({
                description: I18n.instance.t(
...
export const handleGetRoleListError = (error: AxiosError<HttpErrorResponseDataInterface>): void => {
    if (error.response && error.response.data && error.response.data.description) {
        store.dispatch(
            addAlert({
                description: I18n.instance.t(
