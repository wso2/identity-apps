...
import { PresentationDefinitionListInterface } from "../models/connection";

/**
 * Hook to fetch the list of presentation definitions.
 *
 * @param shouldFetch - Whether to trigger the fetch.
 * @returns RequestResultInterface with the presentation definition list.
 */
export const useGetPresentationDefinitionList = (
