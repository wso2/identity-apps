 ...
 */
interface MicrosoftAuthenticatorQuickStartPropsInterface extends IdentifiableComponentInterface {
    /**
        ...
        },
        {
            stepContent: (
                <>
                    <Text>
                        <Trans
                            i18nKey={ "extensions:develop.identityProviders.microsoft.quickStart.steps." +
...
MicrosoftAuthenticatorQuickStart.defaultProps = {
    "data-componentid": "microsoft-authenticator-quick-start"
};
