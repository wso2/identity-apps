...
const MicrosoftExecution = ({
    resource,
    "data-componentid": componentId = "microsoft-execution"
}: MicrosoftExecutionPropsInterface): ReactElement => {
    ...
    return (
        <Box display="flex" gap={ 1 } data-componentid={ componentId }>
            <img src={ loadStaticResource("assets/images/icons/microsoft.svg") } height="20" alt="" />
            <Typography variant="body1">{ t("flows:core.executions.names.microsoft") }</Typography>
        </Box>
    );
};

export default MicrosoftExecution;
