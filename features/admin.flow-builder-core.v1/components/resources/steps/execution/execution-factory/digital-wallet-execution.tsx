...
/**
 * Props interface of {@link DigitalWalletExecution}.
 */
type DigitalWalletExecutionPropsInterface = ExecutionMinimalPropsInterface
    & IdentifiableComponentInterface;

const DigitalWalletExecution = ({
    resource,
    "data-componentid": componentId = "digital-wallet-execution"
}: DigitalWalletExecutionPropsInterface): ReactElement => {
    ...
    return (
        <Box display="flex" gap={ 1 } data-componentid={ componentId } className="flow-builder-execution digital-wallet">
            <img src={ loadStaticResource("connections/assets/images/logos/wallet.svg") } height="20" />
            <Typography variant="body1">{ t("flows:core.executions.names.digitalWallet") }</Typography>
        </Box>
    );
};

export default DigitalWalletExecution;
