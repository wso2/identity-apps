...
/**
 * Props interface of {@link DaonExecution}.
 */
type DaonExecutionPropsInterface = ExecutionMinimalPropsInterface
    & IdentifiableComponentInterface;

const DaonExecution = ({
    resource,
    "data-componentid": componentId = "daon-execution"
}: DaonExecutionPropsInterface): ReactElement => {
    ...
    return (
        <Box display="flex" gap={ 1 } data-componentid={ componentId }>
            <img src={ loadStaticResource("assets/images/icons/daon.svg") } height="20" />
            <Typography variant="body1">{ t("flows:core.executions.names.daon") }</Typography>
        </Box>
    );
};

export default DaonExecution;
