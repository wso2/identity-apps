...
import MarketingConsentAdapter from "./adapters/marketing-consent-adapter";
...
const CommonElementFactory: FunctionComponent<CommonElementFactoryPropsInterface> = ({
    ...
    } else if (resource.type === ElementTypes.Marketing) {
        return <MarketingConsentAdapter stepId={ stepId } resource={ resource } />;
