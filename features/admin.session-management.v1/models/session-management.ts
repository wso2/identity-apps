...
/**
 * The interface for session management config form.
 */
...
/**
 * The interface for session management config form validations.
 */
...
/**
 * The interface of the API response for session Management config editing.
 */
