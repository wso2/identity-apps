...
export const OIDCScopeList: FunctionComponent<OIDCScopesListPropsInterface> = (
    ...
    const hasOidcScopeUpdatePermissions: boolean = useRequiredScopes(featureConfig?.oidcScopes?.scopes?.update);
