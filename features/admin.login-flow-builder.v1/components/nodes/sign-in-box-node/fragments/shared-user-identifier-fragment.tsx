...
/**
 * Proptypes for the Shared User Identifier fragment component.
 */
export interface SharedUserIdentifierFragmentPropsInterface extends IdentifiableComponentInterface {
    /**
...
/**
 * Shared User Identifier fragment login option component with input fields.
 *
        ...
        <div className="identifier-first-fragment" data-componentid={ componentId }>
            ...
            <BasicSignInOptionControls
                ...
                optionSwitchTooltipContent={
                    t("authenticationFlow:nodes.sharedUserIdentifier.controls.optionSwitchTooltipContent")
                }
                optionRemoveTooltipContent={
                    t("authenticationFlow:nodes.sharedUserIdentifier.controls.optionRemoveTooltipContent")
                }
            >
                <TextField
                    required
                    fullWidth
                    label={ t("authenticationFlow:nodes.sharedUserIdentifier.form.fields.username.label") }
                    name="text"
                    autoComplete="off"
                    value={ null }
                    placeholder={
                        t("authenticationFlow:nodes.sharedUserIdentifier.form.fields.username.placeholder")
                    }
            ...
            <FormGroup className="non-interactive">
                <FormControlLabel
                    ...
                    label={ t("authenticationFlow:nodes.sharedUserIdentifier.form.fields.rememberMe.label") }
                />
            </FormGroup>
            <Button
                color="primary"
                ...
                fullWidth
            >
                { t("authenticationFlow:nodes.sharedUserIdentifier.form.actions.primary") }
            </Button>
        </div>
    );
};
