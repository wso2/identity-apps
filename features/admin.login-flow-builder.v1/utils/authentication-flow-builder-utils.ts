...
export const isCustomAuthenticator = (authenticator: GenericAuthenticatorInterface): boolean => {
    return authenticator?.defaultAuthenticator?.tags?.includes("Custom");
};

export const isSecondFactorAuthenticator = (authenticator: GenericAuthenticatorInterface): boolean => {
