...
/**
 * Custom hook to get the password history count properties.
 *
 ...
 *
 * @example
 * `const { data, error, isLoading, isValidating, mutate } = useGetPasswordHistoryCount();`
 */
const useGetPasswordHistoryCount = <
...
export default useGetPasswordHistoryCount;
