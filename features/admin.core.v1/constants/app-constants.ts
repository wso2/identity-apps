...
export class AppConstants {
    ...
    public static getPaths(): Map<string, string> {
        const paths: Map<string, string> = new Map<string, string>([
            ...
            [ "APPLICATIONS_SETTINGS_DCR",
                `${ AppConstants.getDeveloperViewBasePath() }/applications-settings/dcr` ],
            [ "APPLICATIONS_SETTINGS_FUNCTION_LIBRARIES",
                `${ AppConstants.getDeveloperViewBasePath() }/applications-settings/function-libraries` ],
            [ "APPLICATIONS_SETTINGS_FUNCTION_LIBRARY_EDIT",
                `${ AppConstants.getDeveloperViewBasePath() }/applications-settings/function-libraries/:name` ],
