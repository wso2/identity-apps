...
export class AppConstants {
    ...
    public static getPaths(): Map<string, string> {
        const paths: Map<string, string> = new Map<string, string>([
            ...
            [ "LOGS_SETTINGS", `${ AppConstants.getAdminViewBasePath() }/logs-settings` ],
            [ "LOGS_SETTINGS_AUDIT", `${ AppConstants.getAdminViewBasePath() }/logs-settings/audit` ],
            [ "LOGS_SETTINGS_DIAGNOSTICS", `${ AppConstants.getAdminViewBasePath() }/logs-settings/diagnostics` ],
            [ "SESSION_MANAGEMENT",
