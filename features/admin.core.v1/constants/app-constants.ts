...
export class AppConstants {
    ...
    public static getPaths(): Map<string, string> {
        const paths: Map<string, string> = new Map<string, string>([
            ...
            [ "MOESIF_ANALYTICS_LOGIN", `${AppConstants.getAdminViewBasePath()}/moesif-analytics/login` ],
            [ "MOESIF_ANALYTICS_REGISTRATION",
                `${AppConstants.getAdminViewBasePath()}/moesif-analytics/registration` ],
