...
export class AppConstants {
    ...
    public static getPaths(): Map<string, string> {
        const paths: Map<string, string> = new Map<string, string>([
            ...
            [ "POLICY_CONSENTS_COOKIE_POLICY", `${ AppConstants.getDeveloperViewBasePath() }/policy-consents/cookie-policy` ],
            [ "POLICY_CONSENTS_PRIVACY_POLICY", `${ AppConstants.getDeveloperViewBasePath() }/policy-consents/privacy-policy` ],
            [ "POLICY_CONSENTS_TERMS_OF_SERVICE", `${ AppConstants.getDeveloperViewBasePath() }/policy-consents/terms-of-service` ],
