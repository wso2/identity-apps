...
const AIBotAnimated = (props): ReactElement => {
    ...
    const handleMouseMove = (event) => {
        if (rightEyeRef.current) {
            const eyeRect = rightEyeRef.current.getBoundingClientRect(); // Get position and dimension of the eye
            const eyeCenterX = eyeRect.left + eyeRect.width / 2;
            const eyeCenterY = eyeRect.top + eyeRect.height / 2;
            const mouseX = event.clientX - eyeCenterX;
            const mouseY = event.clientY - eyeCenterY;
            const angle = Math.atan2(mouseY, mouseX);
            const eyeRadius = Math.min(eyeRect.width, eyeRect.height) / 2; // Consider eye's physical dimension for radius
            const maxPupilMove = eyeRadius * 0.5; // Adjusting pupil move area to be inside the eye

            const distance = Math.min(maxPupilMove, Math.sqrt(mouseX ** 2 + mouseY ** 2));
    ...
    return (
        <>
            <svg ref={svgRef} width="407" height="412" viewBox="0 0 407 412" fill="none" xmlns="http://www.w3.org/2000/svg" onMouseMove={handleMouseMove}>
                <g id="AI bot">
                    <AnimatedCodeWindow />
                    <g id="Group 297">
                        ...
                        <ellipse id="Ellipse 94" cx="346.052" cy="158.492" rx="19.5403" ry="7.5159" stroke="#F05E58"
                        ...
                        <path id="Vector 144" d="M344.55 198.075L337.535 198.075" stroke="#F05E58" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <ellipse id="Ellipse 102" cx="347.556" cy="197.574" rx="2.50517" ry="2.50529" stroke="#F05E58"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <g id="Group 295">
                        <path id="Path" d="M151.064 57.0583V71.3417H151.151V86.5896L140.88 75.1987H111.35V57.0583H151.064Z"
                            fill="url(#paint2_linear_3948_1292)" />
                        <path id="Path_2" d="M110.065 63.4782V55.7744H131.892" stroke="#F05E58" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Path_3" d="M144.731 61.9124H116.485" stroke="white" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path id="Path_4" d="M126.757 68.3323H116.485" stroke="white" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </g>
                    <ellipse id="Ellipse 73" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                        transform="matrix(0.982719 -0.185106 0.185089 0.982722 81.0996 249.482)" fill="#40404B" />
                    <g id="Group 294">
                        <rect id="Rectangle 114" width="34.0704" height="6.01271"
                            transform="matrix(-0.982718 0.185107 0.185088 0.982722 130.05 312.788)" stroke="#F05E58"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path id="Union_2"
                        ...
                        <path id="Vector 122"
                            ...
                            fill="white" />
                        <ellipse id="Ellipse 66" cx="0.501037" cy="1.00212" rx="0.501037" ry="1.00212"
                            transform="matrix(0.982719 -0.185105 0.18509 0.982722 105.475 296.002)" fill="#40404B" />
                        <ellipse id="Ellipse 67" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                            transform="matrix(0.982719 -0.185106 0.185089 0.982722 112.438 305.908)" fill="#40404B" />
                        <ellipse id="Ellipse 68" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                            transform="matrix(0.982719 -0.185106 0.185089 0.982722 104.932 309.361)" fill="#40404B" />
                        <ellipse id="Ellipse 69" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                            transform="matrix(0.982719 -0.185106 0.185089 0.982722 107.7 307.82)" fill="#40404B" />
                        <ellipse id="Ellipse 70" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                            transform="matrix(0.982719 -0.185106 0.185089 0.982722 108.8 297.415)" fill="#40404B" />
                        <ellipse id="Ellipse 71" cx="0.501036" cy="0.501057" rx="0.501036" ry="0.501057"
                            transform="matrix(0.982719 -0.185106 0.185089 0.982722 109.542 301.355)" fill="#40404B" />
                        <path id="Ellipse 72"
                            ...
                            fill="#40404B" />
                        <ellipse id="Ellipse 74" cx="0.501032" cy="0.501057" rx="0.501032" ry="0.501057"
                            transform="matrix(0.982718 -0.185107 0.185088 0.982722 110.099 304.309)" fill="#40404B" />
                    </g>
                    <g id="Group 293">
                        <path id="Star 2"
                        ...
                        <ellipse id="Ellipse 45" cx="70.4832" cy="171.519" rx="6.51345" ry="6.51378" fill="white" stroke="#506271"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <ellipse id="Ellipse 46" cx="55.4526" cy="190.56" rx="3.50724" ry="3.50742" fill="white" stroke="#506271"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <g id="Group 340">
                        <path id="Polygon 22"
                ...
                <defs>
                    <linearGradient id="paint0_linear_3948_1292" x1="255" y1="69.6272" x2="263.856" y2="104.051"
                    ...
                    <linearGradient id="paint2_linear_3948_1292" x1="131.25" y1="57.0583" x2="131.25" y2="86.5896"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FF9D44" />
                        <stop offset="1" stop-color="#F5C58D" />
                    </linearGradient>
                    ...
                    <linearGradient id="paint4_linear_3948_1292" x1="70.9843" y1="154.984" x2="70.9843" y2="187.052"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FF9D44" />
                        <stop offset="1" stop-color="#F5C58D" />
                    </linearGradient>
                    <linearGradient id="paint5_linear_3948_1292" x1="55.4523" y1="181.04" x2="55.4523" y2="199.078"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FF9D44" />
                        <stop offset="1" stop-color="#F5C58D" />
                    </linearGradient>
                ...
                <g id="bot-face">
                    ...
                    <g id="bot-face-inner">
                        ...
                        <g ref={ leftEyeRef } id="bot-left-eye">
                            ...
                            <motion.path
                                d={`M${184.719 + leftPupilPosition.x - 2.5} ${165.005 + leftPupilPosition.y} L ${184.719 + leftPupilPosition.x + 2.5} ${165.005 + leftPupilPosition.y}`}
                                stroke="#40404B"
                                strokeWidth="2"
                                strokeLinecap="round"
...
const AnimatedTorso = () => (
    ...
    >
        <g id="Group 339">
            ...
            <g id="Mask group">
                <mask id="mask0_3948_1292" maskUnits="userSpaceOnUse" x="165" y="206" width="86"
                    height="70">
...
const AnimatedCodeWindow = () => (
    ...
    >
        <g id="code-window">
            <path id="Vector" d="M277.682 63.7915L232.317 75.4629L241.164 109.889L286.529 98.2175L277.682 63.7915Z"
                fill="url(#paint0_linear_3948_1292)" />
            <path id="Vector_2" d="M243.398 72.6121L263.093 67.5449M273.233 101.638L286.529 98.2176L278.799 68.1371"
                stroke="#506271" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path id="Vector 148" d="M235.744 89.9216L240.028 106.199" stroke="#506271" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" />
            <path id="Vector 100" d="M254.964 83.8203L251.875 89.0423L257.097 92.1314" stroke="white" stroke-width="7"
                stroke-linecap="round" />
            <path id="Vector 101" d="M266.981 89.4102L270.07 84.1882L264.849 81.0991" stroke="white" stroke-width="7"
                stroke-linecap="round" />
            <path id="Vector 102" d="M253.862 83.834L250.315 89.5451L256.464 93.2935" stroke="#506271" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" />
            <path id="Vector 103" d="M265.031 89.8003L268.12 84.5783L262.881 81.8296" stroke="#506271" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" />
        </g>
    </motion.g>
);
