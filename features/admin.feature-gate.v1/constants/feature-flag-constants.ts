...
class FeatureFlagConstants {
    ...
    public static readonly FEATURE_FLAG_KEY_MAP: { [key: string]: string } = {
        ...
        PRESENTATION_DEFINITIONS_FLOWS_TYPES_REGISTRATION: "presentationDefinitions.flows.types.list.registration",
        VERIFIABLE_PRESENTATION_SETTINGS: "verifiablePresentationSettings",
