...
class FeatureFlagConstants {
    ...
    public static readonly FEATURE_FLAG_KEY_MAP: { [key: string]: string } = {
        ...
        APPLICATION_TOGGLE_ENABLE: "console.application.toggleEnable",
        APPROVALS: "approvals",
        ...
        CONNECTIONS_ENTERPRISE_TOGGLE_ENABLE: "console.connections.templates.enterprise.toggleEnable",
        ...
        ORGANIZATIONS_TOGGLE_ENABLE: "console.organizations.toggleEnable",
