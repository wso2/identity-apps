...
/**
 * Hook to fetch the push notification configurations from the API.
 *
 * @param shouldFetch - Whether to fetch the data.
 * @returns Push notification configurations as key-value pairs.
 */
const useGetPushNotificationConfigs = <Data = Record<string, string>, Error = RequestErrorInterface>(
...
export default useGetPushNotificationConfigs;
