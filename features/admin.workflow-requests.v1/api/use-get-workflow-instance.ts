...
/**
 * Hook to get a single workflow instance by ID.
 *
 * @param workflowInstanceId - ID of the workflow instance to be fetched.
 * @param shouldFetch - If true, will fetch the data.
 *
 * @returns workflow instance details.
 */
export const useGetWorkflowInstance = <Data = WorkflowInstanceResponseInterface, Error = RequestErrorInterface>(
