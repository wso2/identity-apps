...
/**
 * Hook to get the workflow model details.
 *
 * @param workflowModelId - Id of the workflow model to be fetched.
 * @param shouldFetch - If true, will fetch the data.
 *
 * @returns workflow model details.
 */
export const useGetWorkflowModelDetails = <Data = WorkflowDetails, Error = RequestErrorInterface>(
