...
/**
 * Activate/Deactivate an Action under a given action type and id.
 *
...
const changeActionStatus = (
    ...
    const requestConfig: RequestConfigInterface = {
        ...
        url: `${ store.getState().config.endpoints.actions }/${ actionType }/${ actionId }/${ status }`
    };
...
export default changeActionStatus;
