...
import "./pre-issue-id-token-action-config-form.scss";

/**
 * Prop types for the action configuration form component.
 */
interface PreIssueIdTokenActionConfigFormInterface extends IdentifiableComponentInterface {
    /**
...
const PreIssueIdTokenActionConfigForm: FunctionComponent<PreIssueIdTokenActionConfigFormInterface> = ({
    initialValues,
    isLoading,
    isReadOnly,
    actionTypeApiPath,
...
}: PreIssueIdTokenActionConfigFormInterface): ReactElement => {
    ...
    const showRuleComponent: boolean = isFeatureEnabled(
        actionsFeatureConfig, ActionsConstants.FEATURE_DICTIONARY.get("PRE_ISSUE_ID_TOKEN_RULE"));
    ...
    const showHeadersAndParams: boolean = isFeatureEnabled(
        actionsFeatureConfig, ActionsConstants.FEATURE_DICTIONARY.get("PRE_ISSUE_ID_TOKEN_HEADERS_AND_PARAMS"));
...
export default PreIssueIdTokenActionConfigForm;
