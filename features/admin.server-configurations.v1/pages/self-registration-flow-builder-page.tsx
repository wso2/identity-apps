...
import "./self-registration-flow-builder-page.scss";

/**
 * Props interface of {@link SelfRegistrationFlowEditPage}
 */
type SelfRegistrationFlowEditPageProps = IdentifiableComponentInterface;

/**
 * Landing page for the Registration Flow Builder.
 *
 * @param props - Props injected to the component.
 * @returns SelfRegistrationFlowEditPage component.
 */
const SelfRegistrationFlowEditPage: FunctionComponent<SelfRegistrationFlowEditPageProps> = ({
    ["data-componentid"]: componentId = "self-registration-flow-builder-page"
}: SelfRegistrationFlowEditPageProps): ReactElement => {
    return (
        <div className="self-registration-flow-builder-page" data-componentid={ componentId }>
...
export default SelfRegistrationFlowEditPage;
