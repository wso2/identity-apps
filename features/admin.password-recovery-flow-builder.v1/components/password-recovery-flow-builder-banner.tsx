            ...
            >
                <Box>
                    <Typography variant="h5">
                        <Trans i18nKey="flows:passwordRecovery.banner.title">
                            Construct your ideal password recovery experience with our new
                    ...
                    <Typography variant="body1">
                        { t("flows:passwordRecovery.banner.description") }
                    </Typography>
                </Box>
                <Button
