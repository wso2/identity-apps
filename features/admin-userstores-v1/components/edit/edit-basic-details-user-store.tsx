                        ...
                        <Grid.Row columns={ 1 }>
                            <Grid.Column width={ 8 }>
                                <Field
                                    ...
                                    placeholder={ t("userstores:forms.general.name" +
                                        ".placeholder") }
                                    value={
                                ...
                                />
                                {
                                    (userstoresConfig.userstoreEdit.basicDetails.showType
                                        ...
                                        && (
                                            <Field
                                                label={ t("userstores:forms.general." +
                                                    "type.label") }
                                                name="type"
                                                type="text"
                                                disabled
                                                required={ false }
                                                requiredErrorMessage={ t("userstores:" +
                                ...
                                }
                                {
                                    <Field
                                        label={
                                            t("userstores:forms.general.description.label") }
                                        name="description"
                    ...
                    <Grid.Column width={ 16 }>
                        ...
                        >
                            <DangerZone
                                ...
                                header={ t("userstores:dangerZone.disable.header") }
