 ...
 * @returns An object containing the data related to the global markdown context.
 */
const useGlobalMarkdown = (): UseGlobalMarkdownInterface => {
    const context: GlobalMarkdownContextProps = useContext(GlobalMarkdownContext);

    if (context === undefined) {
        throw new Error("useGlobalMarkdown hook must be used within a GlobalMarkdownProvider");
    }
