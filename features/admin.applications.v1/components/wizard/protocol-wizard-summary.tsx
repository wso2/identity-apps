...
import { SubmitFormCustomPropertiesInterface, SupportedAuthProtocolTypes } from "../../models/application-inbound";
                ...
                (
                    <Grid.Row className="summary-field" columns={ 2 }>
                        <Grid.Column mobile={ 16 } tablet={ 8 } computer={ 7 } textAlign="right">
                            <div className="label">
                                { t("applications:addWizard.steps.summary.sections.issuer" +
                                    ".heading") }
                            </div>
                        </Grid.Column>
            ...
            }
            {
                ...
                (
                    <Grid.Row className="summary-field" columns={ 2 }>
                        <Grid.Column mobile={ 16 } tablet={ 8 } computer={ 7 } textAlign="right">
                            <div className="label">
                                { t("applications:addWizard.steps.summary.sections" +
