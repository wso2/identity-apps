...
import { ApplicationTabComponentsFilter }
...
export const AdvancedConfigurationsForm: FunctionComponent<AdvancedConfigurationsFormPropsInterface> = (
    ...
    const updateConfiguration = (values: AdvancedConfigurationsInterface): void => {
        ...
        // Fields of a section that is not rendered are never mounted, hence they would serialize as
        // empty values. Omit them from the PATCH payload so the stored configuration is preserved.
        ...
        <>
            ...
            >
                <ApplicationTabComponentsFilter
                    tabId={ ApplicationTabIDs.ADVANCED }
                >
                    <Grid>
                        <Grid.Row columns={ 1 }>
                                                    ...
                                                    <>
                                                        {
                                                            <Trans
                                                                i18nKey={
                                                                    "applications:forms.advancedConfig.sections." +
                                                                    "trustedApps.alerts.trustedAppSettingsAlert"
                                                                }
                                                            >
                                ...
                                <Grid.Row columns={ 1 }>
                                    <Grid.Column>
                                        ...
                                        <Field.Input
                                            ...
                                            required={ false }
                                            placeholder={ t("applications:forms.advancedConfig.sections." +
                                                "platformSettings.fields.apple.fields.appleAppId.placeholder") }
