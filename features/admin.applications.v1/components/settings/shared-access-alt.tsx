...
import { ApplicationShareFormUpdatedAlt } from "../forms/share-application-form-updated-alt";
 ...
 */
export const SharedAccessAlt: FunctionComponent<SharedAccessPropsInterface> = (
            ...
            <EmphasizedSegment className="advanced-configuration-section" padded="very">
                {
                    isRoleSharingEnabled
                        ? (
                            <ApplicationShareFormUpdatedAlt
