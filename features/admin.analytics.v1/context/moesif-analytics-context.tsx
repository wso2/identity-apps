...
/**
 * Interface for the Moesif analytics context value.
 */
export interface MoesifAnalyticsContextInterface {
    /**
...
const MoesifAnalyticsContext: Context<MoesifAnalyticsContextInterface | undefined> =
    createContext<MoesifAnalyticsContextInterface | undefined>(undefined);

MoesifAnalyticsContext.displayName = "MoesifAnalyticsContext";

export default MoesifAnalyticsContext;
