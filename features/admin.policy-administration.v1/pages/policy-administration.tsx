...
import PolicyAdministrationPageLayout from "../components/policy-administration-page-layout";

/**
 * Props interface of {@link PolicyAdministrationPage}
 */
...
}: PolicyAdministrationPageProps): ReactElement => {
    return <PolicyAdministrationPageLayout data-componentid={ `${componentId}-layout` } />;
};

export default PolicyAdministrationPage;
