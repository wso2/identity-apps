 ...
 */
export type PasswordRecoveryEmailOTPFragmentInterface = IdentifiableComponentInterface;
            ...
            <div className="segment-form">
                <form method="post" id="otpForm" className="ui large form otp-form">
                    ...
                    <div>
                        ...
                        >
                            { i18n(CustomTextPreferenceConstants.TEXT_BUNDLE_KEYS.PASSWORD_RECOVERY.BUTTON.EMAIL_OTP,
                                "Send Email OTP") }
                        </button>
                        <button
                            type="submit"
