 ...
 */
export type PasswordRecoveryFragmentSmsOtpInterface = IdentifiableComponentInterface;
 ...
 */
const PasswordRecoverySMSFragment: FunctionComponent<PasswordRecoveryFragmentSmsOtpInterface> = (
    props: PasswordRecoveryFragmentSmsOtpInterface
): ReactElement => {
            ...
            <div className="segment-form">
                <form method="post" id="totpForm" className="ui large form otp-form">
                    ...
                    <div>
                        ...
                        >
                            { i18n(CustomTextPreferenceConstants.TEXT_BUNDLE_KEYS.PASSWORD_RECOVERY.BUTTON.SMS_OTP,
                                "Send SMS Code") }
                        </button>
                        <button
                            type="submit"
 ...
 */
PasswordRecoverySMSFragment.defaultProps = {
    "data-componentid": "branding-preview-password-recovery-fragment"
};

export default PasswordRecoverySMSFragment;
