...
export class BrandingPreferenceMeta {
     ...
     * of fallbacks.
     *
     * @param systemTheme - Selected Theme.
     * @returns Branding internal fallbacks.
     */
    public static getBrandingPreferenceInternalFallbacks(systemTheme: string): {
        theme: {
            [ PredefinedThemes.DARK ]: {
                images: Pick<BrandingPreferenceImagesInterface, "favicon"> & {
                    ...
                    myAccountLogo: Partial<BrandingPreferenceImagesInterface[ "logo" ]>
                }
            },
    ...
    public static getThemeSwatchConfigs(theme: PredefinedThemes): ThemeSwatchUIConfigsInterface {
        ...
        return {
            colors: {
                ...
                primary: {
                    main: DEFAULT_THEME_SWATCH_PRIMARY_COLOR
                },
                secondary: {
                    main: DEFAULT_THEME_SWATCH_SECONDARY_COLOR
                }
            },
            displayName: "Light",
    ...
    public static getThemeSkeleton(theme: BrandingPreferenceThemeInterface): string {
        ...
        --oxygen-palette-customComponents-AppShell-Main-background: ${ theme[ theme.activeTheme ].colors.background?.body?.main };
        --oxygen-palette-customComponents-AppShell-MainWrapper-background: ${ theme[ theme.activeTheme ].colors.background?.surface?.dark };
        --oxygen-palette-background-paper: ${ theme[ theme.activeTheme ].colors.background?.surface?.main };
        --oxygen-palette-AppBar-defaultBg: ${ theme[ theme.activeTheme ].colors.background?.surface?.dark };
        --oxygen-palette-customComponents-Navbar-background: ${ theme[ theme.activeTheme ].colors.background?.surface?.dark };
        --oxygen-palette-primary-main: ${ theme[ theme.activeTheme ].colors.primary.main };
        --oxygen-palette-primary-light: ${ theme[ theme.activeTheme ].colors.primary.light };
        --oxygen-palette-primary-dark: ${ theme[ theme.activeTheme ].colors.primary.dark };
        --oxygen-palette-action-selected: ${ theme.activeTheme === PredefinedThemes.DARK ? "rgba(255, 255, 255, 0.16)" : "rgba(0, 0, 0, 0.08)" };
    }
