 ...
 */
const updateNewAskPasswordPortalFeatureStatus = (enable: boolean = true): Promise<any> => {
    const payload: UpdateGovernanceConnectorConfigInterface = {
        operation: "UPDATE",
        properties: [
            {
                name: AskPasswordFlowBuilderConstants.FLOW_BUILDER_STATUS_CONFIG_KEY,
...
export default updateNewAskPasswordPortalFeatureStatus;
