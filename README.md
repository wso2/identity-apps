...
5. Navigate to `https://localhost:9443/user-portal` or `https://localhost:9443/console` from the browser. (Add certificate exception if required)
...
9. Once the app is successfully started, you can access the via the URLs `https://localhost:9000/user-portal` or `https://localhost:9001/console`.
