...
<div>
    <h3 class="ui header">
        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "we.found.asgardeo.account.with.email")%>
    </h3>
</div>
            ...
            <div id="account-link">
                <c:forEach var="input" items='${requestScope.data["inputs"]}'>
                    <div id="account-link-message" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group required">
                        ...
                        <p style="text-align:left;"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "you.already.have.asgardeo.account")%>
                        ...
                        <p style="text-align:left;"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "click")%>
                            ...
                            <%=AuthenticationEndpointUtil.i18n(resourceBundle, "to.link.asgardeo.to")%>
