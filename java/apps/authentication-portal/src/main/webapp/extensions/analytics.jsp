...
function trackEvent(eventName,metadataObj) {
    AppInsights.getInstance().trackEvent(eventName,metadataObj);
}
</script>

<%
    // String is_cookiepro_enabled = System.getenv("is_cookiepro_enabled");
    String is_cookiepro_enabled = "false";
    ...
    String appInsightsEnabled = "true";
    String appInsightsInstrumentationKey = "342ac3dc-c6fc-4e6c-953b-724b8e6ea9d5";
