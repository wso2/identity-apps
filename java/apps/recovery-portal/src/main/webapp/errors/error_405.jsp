...
<%
    String stat = IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "error.405");
%>
    ...
    <layout:main layoutName="<%= layout %>" layoutFileRelativePath="<%= layoutFileRelativePath %>" data="<%= layoutData %>" >
        ...
        <layout:component componentName="MainSection" >
            <div class="ui orange attached segment mt-3">
                <h3 class="ui header text-center slogan-message mt-3 mb-2" data-testid="recovery-portal-error-405-page-header">
                    <%=Encode.forHtml(stat)%>
                </h3>
            </div>
