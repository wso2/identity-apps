...
const myAccount = {
    components: {
            ...
            emailRecovery: {
                ...
                notifications: {
                    updateEmail: {
                        ...
                        success: {
                            description: "Het e-mailadres in het gebruikersprofiel is succesvol " +
                                "bijgewerkt",
        ...
        changePassword: {
                ...
                passwordResetForm: {
                    ...
                    validations: {
                        ...
                        invalidCurrentPassword: {
                            description: "Het huidige wachtwoord dat u heeft ingevoerd lijkt ongeldig te zijn. " +
                                "Probeer het opnieuw",
                            message: "Fout bij het wijzigen van het wachtwoord"
                        },
                        invalidNewPassword: {
                        ...
                        passwordCaseRequirement: "Ten minste {{minUpperCase}} hoofdletter(s) en {{minLowerCase}} " +
                            "kleine letter(s)",
            ...
            modals: {
                confirmationModal: {
                    heading: "Bevestiging",
                    message:
                        "Het bijwerken van uw wachtwoord kan u afmelden bij alle toepassingen. " +
                        "Als u wordt afgemeld, meld u dan opnieuw aan met uw nieuwe wachtwoord. " +
                        "Wilt u doorgaan?"
                }
            }
        },
            ...
            editConsent: {
                ...
                dangerZones: {
                    revoke: {
                        ...
                        subheader: "U zult opnieuw toestemming moeten geven om weer toegang te krijgen tot " +
                            "deze toepassing."
                    }
                },
                description: "Beschrijving",
                piiCategoryHeading:
                    "Beheer de toestemming voor het verzamelen en delen van uw persoonlijke gegevens " +
                    "met de toepassing. Schakel de attributen uit die u wilt intrekken en bevestig vervolgens door " +
                    "op de knop Bijwerken te klikken om de wijzigingen op te slaan, of klik " +
                    "op de knop Intrekken om de toestemming voor alle attributen te verwijderen.",
                state: "Status",
                version: "Versie"
            },
            modals: {
                consentRevokeModal: {
                    ...
                    message:
                        "Deze bewerking is onomkeerbaar. Hiermee wordt de toestemming voor " +
                        "alle attributen definitief ingetrokken. Weet u zeker dat u wilt doorgaan?",
        ...
        cookieConsent: {
            ...
            content: "We gebruiken cookies om u de best mogelijke algemene ervaring te garanderen. Deze cookies " +
                "worden gebruikt om een doorlopende sessie te onderhouden en tegelijkertijd vloeiende en " +
                "gepersonaliseerde diensten te bieden. Voor meer informatie over hoe we cookies gebruiken, " +
                "raadpleegt u ons <1>Cookiebeleid</1>."
        },
        federatedAssociations: {
            deleteConfirmation: "Hiermee wordt de toegang tot uw account door de externe authenticatiedienst verwijderd. " +
                "Bevestigt u de verwijdering?",
            notifications: {
                getFederatedAssociations: {
                    ...
                    genericError: {
                        description: "Kan de externe authenticatiediensten die toegang " +
                            "hebben tot uw account niet ophalen",
                        message: "Er is iets misgegaan"
                    },
                    success: {
                        description: "De externe authenticatiediensten die toegang hebben tot uw account zijn " +
                            "succesvol opgehaald",
                ...
                removeAllFederatedAssociations: {
                    ...
                    genericError: {
                        description: "Kan niet alle externe authenticatiediensten die toegang hebben tot uw " +
                            "account verwijderen",
                        message: "Er is iets misgegaan"
                    },
                    success: {
                        description: "Toegang succesvol verwijderd voor alle externe authenticatiediensten " +
                            "die toegang hadden tot uw account.",
                ...
                removeFederatedAssociation: {
                    ...
                    genericError: {
                        description: "De toegang tot uw account door de externe authenticatiedienst kon niet " +
                            "worden verwijderd",
                        message: "Er is iets misgegaan"
                    },
                    success: {
                        description: "De toegang tot uw account door de externe authenticatiedienst is succesvol " +
                            "verwijderd",
                        message: "Toegang succesvol verwijderd"
                    }
                }
        ...
        linkedAccounts: {
            ...
            deleteConfirmation: "Hiermee wordt de koppeling met uw account verwijderd. Bevestigt u" +
                "de verwijdering?",
            forms: {
                addAccountForm: {
                    inputs: {
            ...
            notifications: {
                ...
                getAssociations: {
                    ...
                    success: {
                        description: "De vereiste informatie over het gebruikersprofiel is succesvol " +
                            "opgehaald",
        ...
        loginVerifyData: {
            ...
            modals: {
                clearTypingPatternsModal: {
                    heading: "Bevestiging",
                    message: "Met deze actie worden uw opgeslagen typpatronen in TypingDNA gewist. " +
                        "Wilt u doorgaan?"
                }
            },
            notifications: {
                clearTypingPatterns: {
                    error: {
                        description: "De typpatronen konden niet worden gewist. Neem contact op met " +
                            "uw sitebeheerder",
        ...
        mfa: {
            authenticatorApp: {
                ...
                configuredDescription: "U kunt de TOTP-codes van uw " +
                    "geconfigureerde authenticatortoepassing gebruiken voor " +
                    "tweefactorauthenticatie. Als u geen toegang heeft tot de toepassing, kunt u " +
                    "hier een nieuwe authenticatortoepassing configureren",
                deleteHint: "Verwijderen",
                description: "Scan de QR-code met een authenticatortoepassing om " +
                    "tijdgebaseerde eenmalige wachtwoorden (ook wel TOTP genoemd) " +
                    "te gebruiken als tweede factor bij het aanmelden bij toepassingen.",
                ...
                modals: {
                    delete : {
                        heading: "Bevestiging",
                        message: "Met deze actie wordt de QR-code die aan uw profiel is toegevoegd verwijderd. " +
                            "Wilt u doorgaan? "
                    },
                    done: "Geslaagd! U kunt nu uw authenticatortoepassing gebruiken voor " +
                    ...
                    toolTip: "Heeft u geen toepassing? Download een authenticatortoepassing " +
                        "zoals Google Authenticator uit de <1>App Store</1> of <3>Google Play</3>",
                    verify: {
                ...
                notifications: {
                    deleteError: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het verwijderen van de " +
                                "TOTP-authenticatorconfiguratie",
                            message: "Er is iets misgegaan"
                        }
                    },
                    deleteSuccess: {
                    ...
                    updateAuthenticatorError: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het bijwerken van " +
                                "de lijst met ingeschakelde authenticators",
                            message: "Er is iets misgegaan"
                        }
                    }
                },
            ...
            backupCode: {
                ...
                description: "Gebruik back-upcodes om toegang te krijgen tot uw account in het geval dat u geen " +
                    "multifactor-authenticatiecodes kunt ontvangen. U kunt indien nodig nieuwe codes opnieuw genereren.",
                download: {
                    ...
                    subHeading: "U kunt deze back-upcodes gebruiken om u aan te melden bij " +
                        "Asgardeo wanneer u niet bij uw telefoon kunt. Bewaar deze back-upcodes " +
                        "op een veilige maar toegankelijke plaats."
                },
                ...
                modals: {
                    ...
                    delete: {
                        description: "Met deze actie worden de back-upcodes verwijderd en kunt u ze niet meer gebruiken. " +
                            "Wilt u doorgaan?",
                        heading: "Bevestiging"
                    },
                    description: "Gebruik de back-upcodes om u aan te melden wanneer u niet bij " +
                        "uw telefoon kunt. U kunt er meer genereren wanneer ze allemaal zijn gebruikt",
                    generate: {
                        description: "Al uw back-upcodes zijn gebruikt. " +
                            "Hiermee genereert u een nieuwe set back-upcodes",
                        heading: "Genereren"
                    },
                    heading: "Back-upcodes",
                    info: "Elke code kan slechts één keer worden gebruikt",
                    regenerate: {
                        description: "Nadat u nieuwe codes heeft gegenereerd, werken uw oude codes niet meer. "
                            + "Zorg ervoor dat u de nieuwe codes opslaat zodra ze zijn gegenereerd.",
                        heading: "Bevestiging"
                    },
                    subHeading: "Eenmalige toegangscodes die u kunt gebruiken om u aan te melden",
                    warn: "Deze codes verschijnen slechts één keer. Zorg ervoor dat u ze nu opslaat "
                        + "en op een veilige maar toegankelijke plaats bewaart."
                },
                ...
                notifications: {
                    ...
                    downloadError: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het downloaden van de " +
                                "back-upcodes",
                            message: "Er is iets misgegaan"
                        }
                    },
                    ...
                    refreshError: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het " +
                                "genereren van nieuwe back-upcodes",
                            message: "Er is iets misgegaan"
                        }
                    },
                    retrieveAuthenticatorError: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het ophalen van " +
                                "de lijst met ingeschakelde authenticators",
                            message: "Er is iets misgegaan"
                        }
                    },
            ...
            fido: {
                description: "U kunt een <1>passkey</1>, een " +
                    "<1>FIDO-beveiligingssleutel</1> of <1>biometrische gegevens</1> " +
                    "op uw apparaat gebruiken om u aan te melden bij uw account.",
                form: {
                    label: "Passkey",
                ...
                modals: {
                    deleteConfirmation: {
                        ...
                        description: "Als u deze passkey verwijdert, kunt u zich mogelijk niet meer " +
                            "aanmelden bij uw account. Ga met voorzichtigheid te werk.",
                        heading: "Weet u het zeker?"
                    },
                    deviceRegistrationErrorModal: {
                        description: "De registratie van de passkey is onderbroken. " +
                            "Als dit niet de bedoeling was, kunt u de flow opnieuw proberen.",
                ...
                notifications: {
                    removeDevice: {
                        ...
                        genericError: {
                            description: "Er is een fout opgetreden bij het verwijderen van de " +
                                "beveiligings-/biometrische sleutel",
                            message: "Er is iets misgegaan"
                        },
                        success: {
                    ...
                    startFidoFlow: {
                        ...
                        success: {
                            description: "De passkey is succesvol geregistreerd en u kunt deze nu " +
            ...
            smsOtp: {
                ...
                notifications: {
                    updateMobile: {
                        error: {
                            description: "{{description}}",
                            message: "Er is een fout opgetreden bij het bijwerken van het mobiele " +
                                "herstelnummer"
                        },
                        genericError: {
                            description: "Er is een fout opgetreden bij het bijwerken van het mobiele " +
                                "herstelnummer",
                            message: "Er is iets misgegaan"
                        },
                        success: {
                            description: "Het mobiele nummer in het gebruikersprofiel is succesvol " +
                                "bijgewerkt",
        ...
        mobileUpdateWizard: {
            ...
            notifications: {
                resendError: {
                    ...
                    genericError: {
                        description: "Er is een fout opgetreden bij het ophalen van een nieuwe " +
                            "verificatiecode",
                        message: "Er is een probleem opgetreden"
                    }
                },
        ...
        profile: {
            ...
            forms: {
                ...
                dateChangeForm: {
                    inputs: {
                        date: {
                            validations: {
                                futureDateError: "De datum die u heeft ingevoerd voor het veld {{field}} " +
                                "is ongeldig.",
                ...
                emailChangeForm: {
                    inputs: {
                        email: {
                            label: "E-mail",
                            note: "OPMERKING: Hiermee wijzigt u het e-mailadres dat aan dit account is gekoppeld. " +
                                "Dit e-mailadres wordt ook gebruikt voor accountherstel.",
                            placeholder: "Voer uw e-mailadres in",
                            validations: {
                                empty: "E-mailadres is verplicht",
                                invalidFormat: "Het formaat van het ingevoerde e-mailadres is ongeldig. U kunt " +
                                    "alfanumerieke tekens, Unicode-tekens, underscores (_), " +
                                    "streepjes (-), punten (.) en een apenstaartje (@) gebruiken."
                            }
                        }
                    }
                },
                ...
                mobileChangeForm: {
                    inputs: {
                        mobile: {
                            ...
                            note: "OPMERKING: Het gekoppelde mobiele telefoonnummer van uw gebruikersprofiel " +
                                "wordt gewijzigd",
                            placeholder: "Voer uw mobiele nummer in",
                            validations: {
                                empty: "Mobiel nummer is een verplicht veld",
                                invalidFormat: "Voer een geldig mobiel nummer in het formaat [+][landcode][netnummer]"+
                                    "[lokaal telefoonnummer] in."
                            }
                        }
                    }
                },
            ...
            messages: {
                ...
                mobileVerification: {
                    content: "Dit mobiele nummer wordt gebruikt voor het verzenden van SMS-OTP wanneer " +
                        "tweefactorauthenticatie is ingeschakeld en voor het verzenden van herstelcodes in geval " +
                        "van herstel van een gebruikersnaam/wachtwoord. Om dit nummer bij te werken, " +
                        "moet u het nieuwe nummer verifiëren door de verificatiecode in te voeren die naar uw " +
                        "nieuwe nummer is verzonden. Klik op bijwerken als u wilt doorgaan."
                }
            },
            modals: {
            ...
            notifications: {
                ...
                getUserReadOnlyStatus: {
                    genericError: {
                        description: "Er is een fout opgetreden bij het ophalen van de alleen-lezen-status " +
                            "van de gebruiker",
                        message: "Er is iets misgegaan"
                    }
                },
        ...
        profileExport: {
            notifications: {
                downloadProfileInfo: {
                    ...
                    genericError: {
                        description: "Er is een fout opgetreden bij het downloaden van uw " +
                            "gebruikersprofielgegevens",
                        message: "Er is iets misgegaan"
                    },
                    success: {
                        description: "Het downloaden van het bestand met uw gebruikersprofielgegevens " +
                            "is gestart",
        ...
        systemNotificationAlert: {
            resend: "Opnieuw verzenden",
            selfSignUp: {
                awaitingAccountConfirmation: "Uw account is nog niet actief. We hebben een " +
                    "activeringslink naar uw geregistreerde e-mailadres gestuurd. Heeft u een nieuwe link nodig?",
                notifications: {
                    resendError: {
        ...
        userSessions: {
            ...
            modals: {
                terminateActiveUserSessionModal: {
                    ...
                    message:
                        "Wijzigingen aan de tweefactorauthenticatie (2FA)-optie worden niet toegepast op uw actieve sessies. We " +
                        "raden u aan deze te beëindigen.",
                ...
                terminateAllUserSessionsModal: {
                    heading: "Bevestiging",
                    message:
                        "Met deze actie wordt u afgemeld bij deze sessie en alle andere sessies op " +
                        "elk apparaat. Wilt u doorgaan?"
                },
                terminateUserSessionModal: {
                    heading: "Bevestiging",
                    message:
                        "Met deze actie wordt de toegang tot uw account vanaf dit apparaat verwijderd. " +
                        "Wilt u doorgaan?"
                }
            },
            notifications: {
    ...
    modals: {
        editAvatarModal: {
            content: {
                gravatar: {
                    errors: {
                        noAssociation: {
                            content: "Het lijkt erop dat het geselecteerde e-mailadres niet is geregistreerd bij " +
                                "Gravatar. Maak een account aan via <1>de officiële Gravatar-website</1> " +
                                "of gebruik een van de afbeeldingen hieronder.",
                ...
                hostedAvatar: {
                    ...
                    input: {
                        errors: {
                            http: {
                                content: "De geselecteerde URL verwijst naar een onbeveiligde bron (HTTP). " +
                                    "Wees voorzichtig.",
                        ...
                        warnings: {
                            dataURL: {
                                content: "Het gebruik van URL's met een groot aantal " +
                                    "tekens kan problemen veroorzaken in de " +
                                    "database. Ga met voorzichtigheid te werk",
        ...
        sessionTimeoutModal: {
            description: "Wanneer u op <1>Terug</1> klikt, proberen we de sessie te herstellen " +
                "als deze bestaat. Als u geen actieve sessie heeft, wordt u doorgestuurd naar de aanmeldpagina.",
    ...
    pages: {
        ...
        overview: {
            subTitle: "Beheer uw persoonlijke gegevens, accountbeveiliging en " +
        ...
        readOnlyProfileBanner: "Uw profiel kan vanuit dit portaal niet worden bewerkt. Neem " +
            "contact op met uw beheerder voor meer informatie.",
        security: {
            subTitle: "Beveilig uw account door toestemmingen, geauthenticeerde sessies en " +
                "beveiligingsinstellingen te beheren",
            title: "Beveiliging"
        }
    },
    placeholders: {
        404: {
            ...
            subtitles: {
                ...
                1: "Controleer de URL of klik op de knop hieronder om naar de startpagina te worden " +
                    "doorgestuurd."
            },
        ...
        sessionStorageDisabled: {
            subtitles: {
                0: "Om deze toepassing te kunnen gebruiken, moet u cookies inschakelen in de " +
                    "instellingen van uw webbrowser.",
                1: "Voor meer informatie over het inschakelen van cookies, raadpleegt u de hulpsectie " +
                    "van uw webbrowser."
            },
    ...
    sections: {
        ...
        changePassword: {
            ...
            description: "Zorg ervoor dat u uw wachtwoord regelmatig bijwerkt en het niet opnieuw " +
        ...
        consentManagement: {
            ...
            description:
                "Bekijk de toestemmingen die u voor elke toepassing heeft gegeven. " +
                "Daarnaast kunt u één of meer ervan intrekken naar wens.",
        ...
        createPassword: {
            ...
            description: "Maak een wachtwoord aan in {{productName}}. U kunt dit wachtwoord gebruiken om u aan te " +
                "melden bij {{productName}}, naast de sociale aanmelding.\n",
        ...
        mfa: {
            description:
                "Versterk de bescherming van uw account door meerdere " +
                "authenticatiestappen te configureren.",
            heading: "Authenticatie met meerdere stappen"
        },
        profile: {
            description: "Beheer uw persoonlijke gegevens, zoals uw naam, e-mailadres, " +
                "mobiele nummer, enz.",
            heading: "Profiel"
        },
        profileExport: {
