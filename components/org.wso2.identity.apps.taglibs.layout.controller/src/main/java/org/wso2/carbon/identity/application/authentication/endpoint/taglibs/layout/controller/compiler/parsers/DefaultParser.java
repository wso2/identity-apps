...
package org.wso2.carbon.identity.application.authentication.endpoint.taglibs.layout.controller.compiler.parsers;
...
import org.wso2.carbon.identity.application.authentication.endpoint.taglibs.layout.controller.compiler.resolvers.FileResolver;
import org.wso2.carbon.identity.application.authentication.endpoint.taglibs.layout.controller.compiler.resolvers.Resolver;
...
public class DefaultParser implements Parser {
    ...
    private final ExecutableIdentifier[] emptyList = new ExecutableIdentifier[0];
    ...
    private ExecutableIdentifier createCompiledObject(ArrayList<ExecutableIdentifier> allIdentifiers) {
        ...
        return new DefaultIdentifier(identifiers);
    }
